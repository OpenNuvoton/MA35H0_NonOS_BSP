...
#define INT_ENUMMA35H0NE			(0x1<<13)
...
/* DWC2_UDC_OTG_DIEPINTn/MA35H0EPINTn device IN/OUT endpoint interrupt register */
#define BNAMSK							(0x1<<9)
#define BACK2BACK_SETUP_RECEIVED		(0x1<<6)
#define INTKNEPMIS						(0x1<<5)
#define INTKN_TXFEMP					(0x1<<4)
#define CTRL_OUT_EP_SETUP_PHASE_MA35H0NE	(0x1<<3)
#define AHB_ERROR						(0x1<<2)
#define EPDISBLD						(0x1<<1)
#define TRANSFER_MA35H0NE					(0x1<<0)
...
/* Masks definitions */
#define GINTMSK_INIT	(INT_OUT_EP | INT_IN_EP | INT_RESUME | INT_ENUMMA35H0NE | INT_RESET | INT_SUSPEND)
#define MA35H0EPMSK_INIT	(BNAMSK | CTRL_OUT_EP_SETUP_PHASE_MA35H0NE | AHB_ERROR | TRANSFER_MA35H0NE)
#define DIEPMSK_INIT	(BNAMSK | AHB_ERROR | TRANSFER_MA35H0NE)
...
/* Device Endpoint-N Control Register (DIEPCTLn/MA35H0EPCTLn) */
...
/* DWC2_UDC_OTG_DIEPCTL0/MA35H0EPCTL0 device
...
{
	volatile unsigned int MA35H0epctl;
	volatile const unsigned int res1;
	volatile unsigned int MA35H0epint;
	volatile const unsigned int res2[2];
	volatile unsigned int MA35H0epdma;
	volatile const unsigned int res3;
	volatile unsigned int MA35H0epdmab;
};
...
struct dwc2_usbotg_reg
{
	...
	volatile unsigned int MA35H0epmsk; /* Device OUT Endpoint Common Interrupt Mask */
...
#define USB_TYPE_VENMA35H0R			(0x02 << 5)
 ...
 * TYPE_CLASS or TYPE_VENMA35H0R specific feature flags could be retrieved
