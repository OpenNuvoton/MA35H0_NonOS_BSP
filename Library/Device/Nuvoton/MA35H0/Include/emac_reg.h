/**************************************************************************//**
 * @file     emac_reg.h
 * @brief    EMAC register header file
 *
...
/**  @addtogroup Ethernet Media Access Controller (EMAC)
                 Memory Mapped Structure for EMAC
@{ */
...
typedef struct {
     ...
     * |        |          |However, in EMAC, the MAC compares all 48 bits
     ...
     * |        |          |It is cleared automatically after the reset operation has completed in all of the EMAC clock domains
     * |        |          |Before reprogramming any register of the EMAC, you should read a zero (0) value in this bit .
     * |        |          |Note:
     ...
     * |[26]    |GLI       |EMAC Line interface Interrupt (read only)
     * |        |          |When set, this bit reflects any of the following interrupt events in the EMAC interfaces:
     ...
     * |        |          |The interrupt signal from the EMAC subsystem (sbd_intr_o) is high when this bit is high.
     * |[28]    |GPI       |EMAC PMT Interrupt (read only)
     * |        |          |This bit indicates an interrupt event in the PMT module of the EMAC
     ...
     * |        |          |This bit indicates an interrupt event in the Timestamp Generator block of EMAC
     * |        |          |The software must read the corresponding registers in the EMAC to get the exact cause of interrupt and clear its source to reset this bit to 1'b0
     * |        |          |When this bit is high, the interrupt signal from the EMAC subsystem (sbd_intr_o) is high.
     * |        |          |This bit is applicable only when the IEEE 1588 Timestamp feature is enabled
     * |        |          |Otherwise, this bit is reserved.
     * |[30]    |GLPII     |EMAC LPI Interrupt (read only)
     * |        |          |This bit indicates an interrupt event in the LPI logic of the EMAC
     * |        |          |To reset this bit to 1'b0, the software must read the corresponding registers in the EMAC to get the exact cause of the interrupt and clear its source.
     ...
     * |        |          |Note: When FIFO size is exactly 4 Kbytes, although the EMAC allows you to program the value of these bits to 11, the software should not program these bits to 2'b11
     ...
     * |        |          |u00B7 When this bit is set to 1, the EMAC-AXI is allowed to perform any burst length equal to or below the maximum allowed burst length programmed in Bits[7:1].
     * |        |          |u00B7 When this bit is set to 0, the EMAC-AXI is allowed to perform only fixed burst lengths as indicated by BLEN256, BLEN128, BLEN64, BLEN32, BLEN16, BLEN8, or BLEN4, or a burst length of 1
     * |[1]     |BLEN4     |AXI Burst Length 4
     * |        |          |When this bit is set to 1, the EMAC-AXI is allowed to select a burst length of 4 on the AXI Master interface.
     * |        |          |Setting this bit has no effect when UNDEF is set to 1.
     * |[2]     |BLEN8     |AXI Burst Length 8
     * |        |          |When this bit is set to 1, the EMAC-AXI is allowed to select a burst length of 8 on the AXI Master interface.
     * |        |          |Setting this bit has no effect when UNDEF is set to 1.
     * |[3]     |BLEN16    |AXI Burst Length 16
     * |        |          |When this bit is set to 1 or UNDEF is set to 1, the EMAC-AXI is allowed to select a burst length of 16 on the AXI Master interface.
     ...
     * |        |          |When this bit is set to 1, the EMAC-AXI performs address-aligned burst transfers on both read and write channels.
     * |[13]    |ONEKBBE   |1 Kbytes Boundary Crossing Enable for the EMAC-AXI Master When set, the EMAC-AXI Master performs burst transfers that do not cross 1 Kbytes boundary When reset, the EMAC-AXI Master performs burst transfers that do not cross 4 Kbytes boundary.
     ...
     * |        |          |When set to 1, this bit enables the EMAC-AXI to come out of the LPI mode only when the Magic Packet or Remote Wake Up Packet is received
     * |        |          |When set to 0, this bit enables the EMAC-AXI to come out of LPI mode when any frame is received.
...
/**  @addtogroup EMAC Bit Field Definition
    Constant Definitions for EMAC
@{ */

#define EMAC_Config_PRELEN_Pos              (0)                                             /*!< EMAC_T::Config: PRELEN Position       */
#define EMAC_Config_PRELEN_Msk              (0x3ul << EMAC_Config_PRELEN_Pos)               /*!< EMAC_T::Config: PRELEN Mask           */

#define EMAC_Config_RE_Pos                  (2)                                             /*!< EMAC_T::Config: RE Position           */
#define EMAC_Config_RE_Msk                  (0x1ul << EMAC_Config_RE_Pos)                   /*!< EMAC_T::Config: RE Mask               */

#define EMAC_Config_TE_Pos                  (3)                                             /*!< EMAC_T::Config: TE Position           */
#define EMAC_Config_TE_Msk                  (0x1ul << EMAC_Config_TE_Pos)                   /*!< EMAC_T::Config: TE Mask               */

#define EMAC_Config_DC_Pos                  (4)                                             /*!< EMAC_T::Config: DC Position           */
#define EMAC_Config_DC_Msk                  (0x1ul << EMAC_Config_DC_Pos)                   /*!< EMAC_T::Config: DC Mask               */

#define EMAC_Config_BL_Pos                  (5)                                             /*!< EMAC_T::Config: BL Position           */
#define EMAC_Config_BL_Msk                  (0x3ul << EMAC_Config_BL_Pos)                   /*!< EMAC_T::Config: BL Mask               */

#define EMAC_Config_ACS_Pos                 (7)                                             /*!< EMAC_T::Config: ACS Position          */
#define EMAC_Config_ACS_Msk                 (0x1ul << EMAC_Config_ACS_Pos)                  /*!< EMAC_T::Config: ACS Mask              */

#define EMAC_Config_LUD_Pos                 (8)                                             /*!< EMAC_T::Config: LUD Position          */
#define EMAC_Config_LUD_Msk                 (0x1ul << EMAC_Config_LUD_Pos)                  /*!< EMAC_T::Config: LUD Mask              */

#define EMAC_Config_DR_Pos                  (9)                                             /*!< EMAC_T::Config: DR Position           */
#define EMAC_Config_DR_Msk                  (0x1ul << EMAC_Config_DR_Pos)                   /*!< EMAC_T::Config: DR Mask               */

#define EMAC_Config_IPC_Pos                 (10)                                            /*!< EMAC_T::Config: IPC Position          */
#define EMAC_Config_IPC_Msk                 (0x1ul << EMAC_Config_IPC_Pos)                  /*!< EMAC_T::Config: IPC Mask              */

#define EMAC_Config_DM_Pos                  (11)                                            /*!< EMAC_T::Config: DM Position           */
#define EMAC_Config_DM_Msk                  (0x1ul << EMAC_Config_DM_Pos)                   /*!< EMAC_T::Config: DM Mask               */

#define EMAC_Config_LM_Pos                  (12)                                            /*!< EMAC_T::Config: LM Position           */
#define EMAC_Config_LM_Msk                  (0x1ul << EMAC_Config_LM_Pos)                   /*!< EMAC_T::Config: LM Mask               */

#define EMAC_Config_DO_Pos                  (13)                                            /*!< EMAC_T::Config: DO Position           */
#define EMAC_Config_DO_Msk                  (0x1ul << EMAC_Config_DO_Pos)                   /*!< EMAC_T::Config: DO Mask               */

#define EMAC_Config_FES_Pos                 (14)                                            /*!< EMAC_T::Config: FES Position          */
#define EMAC_Config_FES_Msk                 (0x1ul << EMAC_Config_FES_Pos)                  /*!< EMAC_T::Config: FES Mask              */

#define EMAC_Config_PS_Pos                  (15)                                            /*!< EMAC_T::Config: PS Position           */
#define EMAC_Config_PS_Msk                  (0x1ul << EMAC_Config_PS_Pos)                   /*!< EMAC_T::Config: PS Mask               */

#define EMAC_Config_DCRS_Pos                (16)                                            /*!< EMAC_T::Config: DCRS Position         */
#define EMAC_Config_DCRS_Msk                (0x1ul << EMAC_Config_DCRS_Pos)                 /*!< EMAC_T::Config: DCRS Mask             */

#define EMAC_Config_IFG_Pos                 (17)                                            /*!< EMAC_T::Config: IFG Position          */
#define EMAC_Config_IFG_Msk                 (0x7ul << EMAC_Config_IFG_Pos)                  /*!< EMAC_T::Config: IFG Mask              */

#define EMAC_Config_JE_Pos                  (20)                                            /*!< EMAC_T::Config: JE Position           */
#define EMAC_Config_JE_Msk                  (0x1ul << EMAC_Config_JE_Pos)                   /*!< EMAC_T::Config: JE Mask               */

#define EMAC_Config_BE_Pos                  (21)                                            /*!< EMAC_T::Config: BE Position           */
#define EMAC_Config_BE_Msk                  (0x1ul << EMAC_Config_BE_Pos)                   /*!< EMAC_T::Config: BE Mask               */

#define EMAC_Config_JD_Pos                  (22)                                            /*!< EMAC_T::Config: JD Position           */
#define EMAC_Config_JD_Msk                  (0x1ul << EMAC_Config_JD_Pos)                   /*!< EMAC_T::Config: JD Mask               */

#define EMAC_Config_WD_Pos                  (23)                                            /*!< EMAC_T::Config: WD Position           */
#define EMAC_Config_WD_Msk                  (0x1ul << EMAC_Config_WD_Pos)                   /*!< EMAC_T::Config: WD Mask               */

#define EMAC_Config_TC_Pos                  (24)                                            /*!< EMAC_T::Config: TC Position           */
#define EMAC_Config_TC_Msk                  (0x1ul << EMAC_Config_TC_Pos)                   /*!< EMAC_T::Config: TC Mask               */

#define EMAC_Config_CST_Pos                 (25)                                            /*!< EMAC_T::Config: CST Position          */
#define EMAC_Config_CST_Msk                 (0x1ul << EMAC_Config_CST_Pos)                  /*!< EMAC_T::Config: CST Mask              */

#define EMAC_Config_TWOKPE_Pos              (27)                                            /*!< EMAC_T::Config: TWOKPE Position       */
#define EMAC_Config_TWOKPE_Msk              (0x1ul << EMAC_Config_TWOKPE_Pos)               /*!< EMAC_T::Config: TWOKPE Mask           */

#define EMAC_Config_SARC_Pos                (28)                                            /*!< EMAC_T::Config: SARC Position         */
#define EMAC_Config_SARC_Msk                (0x7ul << EMAC_Config_SARC_Pos)                 /*!< EMAC_T::Config: SARC Mask             */

#define EMAC_FrameFilter_PR_Pos             (0)                                             /*!< EMAC_T::FrameFilter: PR Position      */
#define EMAC_FrameFilter_PR_Msk             (0x1ul << EMAC_FrameFilter_PR_Pos)              /*!< EMAC_T::FrameFilter: PR Mask          */

#define EMAC_FrameFilter_DAIF_Pos           (3)                                             /*!< EMAC_T::FrameFilter: DAIF Position    */
#define EMAC_FrameFilter_DAIF_Msk           (0x1ul << EMAC_FrameFilter_DAIF_Pos)            /*!< EMAC_T::FrameFilter: DAIF Mask        */

#define EMAC_FrameFilter_PM_Pos             (4)                                             /*!< EMAC_T::FrameFilter: PM Position      */
#define EMAC_FrameFilter_PM_Msk             (0x1ul << EMAC_FrameFilter_PM_Pos)              /*!< EMAC_T::FrameFilter: PM Mask          */

#define EMAC_FrameFilter_DBF_Pos            (5)                                             /*!< EMAC_T::FrameFilter: DBF Position     */
#define EMAC_FrameFilter_DBF_Msk            (0x1ul << EMAC_FrameFilter_DBF_Pos)             /*!< EMAC_T::FrameFilter: DBF Mask         */

#define EMAC_FrameFilter_PCF_Pos            (6)                                             /*!< EMAC_T::FrameFilter: PCF Position     */
#define EMAC_FrameFilter_PCF_Msk            (0x3ul << EMAC_FrameFilter_PCF_Pos)             /*!< EMAC_T::FrameFilter: PCF Mask         */

#define EMAC_FrameFilter_SAIF_Pos           (8)                                             /*!< EMAC_T::FrameFilter: SAIF Position    */
#define EMAC_FrameFilter_SAIF_Msk           (0x1ul << EMAC_FrameFilter_SAIF_Pos)            /*!< EMAC_T::FrameFilter: SAIF Mask        */

#define EMAC_FrameFilter_SAF_Pos            (9)                                             /*!< EMAC_T::FrameFilter: SAF Position     */
#define EMAC_FrameFilter_SAF_Msk            (0x1ul << EMAC_FrameFilter_SAF_Pos)             /*!< EMAC_T::FrameFilter: SAF Mask         */

#define EMAC_FrameFilter_VTFE_Pos           (16)                                            /*!< EMAC_T::FrameFilter: VTFE Position    */
#define EMAC_FrameFilter_VTFE_Msk           (0x1ul << EMAC_FrameFilter_VTFE_Pos)            /*!< EMAC_T::FrameFilter: VTFE Mask        */

#define EMAC_FrameFilter_RA_Pos             (31)                                            /*!< EMAC_T::FrameFilter: RA Position      */
#define EMAC_FrameFilter_RA_Msk             (0x1ul << EMAC_FrameFilter_RA_Pos)              /*!< EMAC_T::FrameFilter: RA Mask          */

#define EMAC_GmiiAddr_GB_Pos                (0)                                             /*!< EMAC_T::GmiiAddr: GB Position           */
#define EMAC_GmiiAddr_GB_Msk                (0x1ul << EMAC_GmiiAddr_GB_Pos)                 /*!< EMAC_T::GmiiAddr: GB Mask               */

#define EMAC_GmiiAddr_GW_Pos                (1)                                             /*!< EMAC_T::GmiiAddr: GW Position           */
#define EMAC_GmiiAddr_GW_Msk                (0x1ul << EMAC_GmiiAddr_GW_Pos)                 /*!< EMAC_T::GmiiAddr: GW Mask               */

#define EMAC_GmiiAddr_CR_Pos                (2)                                             /*!< EMAC_T::GmiiAddr: CR Position           */
#define EMAC_GmiiAddr_CR_Msk                (0xful << EMAC_GmiiAddr_CR_Pos)                 /*!< EMAC_T::GmiiAddr: CR Mask               */

#define EMAC_GmiiAddr_GR_Pos                (6)                                             /*!< EMAC_T::GmiiAddr: GR Position           */
#define EMAC_GmiiAddr_GR_Msk                (0x1ful << EMAC_GmiiAddr_GR_Pos)                /*!< EMAC_T::GmiiAddr: GR Mask               */

#define EMAC_GmiiAddr_PA_Pos                (11)                                            /*!< EMAC_T::GmiiAddr: PA Position           */
#define EMAC_GmiiAddr_PA_Msk                (0x1ful << EMAC_GmiiAddr_PA_Pos)                /*!< EMAC_T::GmiiAddr: PA Mask               */

#define EMAC_GmiiData_GD_Pos                (0)                                             /*!< EMAC_T::GmiiData: GD Position              */
#define EMAC_GmiiData_GD_Msk                (0xfffful << EMAC_GmiiData_GD_Pos)              /*!< EMAC_T::GmiiData: GD Mask                  */

#define EMAC_FlowControl_FCA_BPA_Pos        (0)                                             /*!< EMAC_T::FlowControl: FCA_BPA Position      */
#define EMAC_FlowControl_FCA_BPA_Msk        (0x1ul << EMAC_FlowControl_FCA_BPA_Pos)         /*!< EMAC_T::FlowControl: FCA_BPA Mask          */

#define EMAC_FlowControl_TFE_Pos            (1)                                             /*!< EMAC_T::FlowControl: TFE Position          */
#define EMAC_FlowControl_TFE_Msk            (0x1ul << EMAC_FlowControl_TFE_Pos)             /*!< EMAC_T::FlowControl: TFE Mask              */

#define EMAC_FlowControl_RFE_Pos            (2)                                             /*!< EMAC_T::FlowControl: RFE Position          */
#define EMAC_FlowControl_RFE_Msk            (0x1ul << EMAC_FlowControl_RFE_Pos)             /*!< EMAC_T::FlowControl: RFE Mask              */

#define EMAC_FlowControl_UP_Pos             (3)                                             /*!< EMAC_T::FlowControl: UP Position           */
#define EMAC_FlowControl_UP_Msk             (0x1ul << EMAC_FlowControl_UP_Pos)              /*!< EMAC_T::FlowControl: UP Mask               */

#define EMAC_FlowControl_PLT_Pos            (4)                                             /*!< EMAC_T::FlowControl: PLT Position          */
#define EMAC_FlowControl_PLT_Msk            (0x3ul << EMAC_FlowControl_PLT_Pos)             /*!< EMAC_T::FlowControl: PLT Mask              */

#define EMAC_FlowControl_DZPQ_Pos           (7)                                             /*!< EMAC_T::FlowControl: DZPQ Position         */
#define EMAC_FlowControl_DZPQ_Msk           (0x1ul << EMAC_FlowControl_DZPQ_Pos)            /*!< EMAC_T::FlowControl: DZPQ Mask             */

#define EMAC_FlowControl_PT_Pos             (16)                                            /*!< EMAC_T::FlowControl: PT Position           */
#define EMAC_FlowControl_PT_Msk             (0xfffful << EMAC_FlowControl_PT_Pos)           /*!< EMAC_T::FlowControl: PT Mask               */

#define EMAC_VlanTag_VL_Pos                 (0)                                             /*!< EMAC_T::VlanTag: VL Position               */
#define EMAC_VlanTag_VL_Msk                 (0xfffful << EMAC_VlanTag_VL_Pos)               /*!< EMAC_T::VlanTag: VL Mask                   */

#define EMAC_VlanTag_ETV_Pos                (16)                                            /*!< EMAC_T::VlanTag: ETV Position              */
#define EMAC_VlanTag_ETV_Msk                (0x1ul << EMAC_VlanTag_ETV_Pos)                 /*!< EMAC_T::VlanTag: ETV Mask                  */

#define EMAC_VlanTag_VTIM_Pos               (17)                                            /*!< EMAC_T::VlanTag: VTIM Position             */
#define EMAC_VlanTag_VTIM_Msk               (0x1ul << EMAC_VlanTag_VTIM_Pos)                /*!< EMAC_T::VlanTag: VTIM Mask                 */

#define EMAC_VlanTag_ESVL_Pos               (18)                                            /*!< EMAC_T::VlanTag: ESVL Position             */
#define EMAC_VlanTag_ESVL_Msk               (0x1ul << EMAC_VlanTag_ESVL_Pos)                /*!< EMAC_T::VlanTag: ESVL Mask                 */

#define EMAC_Debug_RPESTS_Pos               (0)                                             /*!< EMAC_T::Debug: RPESTS Position         */
#define EMAC_Debug_RPESTS_Msk               (0x1ul << EMAC_Debug_RPESTS_Pos)                /*!< EMAC_T::Debug: RPESTS Mask             */

#define EMAC_Debug_RFCFCSTS_Pos             (1)                                             /*!< EMAC_T::Debug: RFCFCSTS Position       */
#define EMAC_Debug_RFCFCSTS_Msk             (0x3ul << EMAC_Debug_RFCFCSTS_Pos)              /*!< EMAC_T::Debug: RFCFCSTS Mask           */

#define EMAC_Debug_RWCSTS_Pos               (4)                                             /*!< EMAC_T::Debug: RWCSTS Position         */
#define EMAC_Debug_RWCSTS_Msk               (0x1ul << EMAC_Debug_RWCSTS_Pos)                /*!< EMAC_T::Debug: RWCSTS Mask             */

#define EMAC_Debug_RRCSTS_Pos               (5)                                             /*!< EMAC_T::Debug: RRCSTS Position         */
#define EMAC_Debug_RRCSTS_Msk               (0x3ul << EMAC_Debug_RRCSTS_Pos)                /*!< EMAC_T::Debug: RRCSTS Mask             */

#define EMAC_Debug_RXFSTS_Pos               (8)                                             /*!< EMAC_T::Debug: RXFSTS Position         */
#define EMAC_Debug_RXFSTS_Msk               (0x3ul << EMAC_Debug_RXFSTS_Pos)                /*!< EMAC_T::Debug: RXFSTS Mask             */

#define EMAC_Debug_TPESTS_Pos               (16)                                            /*!< EMAC_T::Debug: TPESTS Position         */
#define EMAC_Debug_TPESTS_Msk               (0x1ul << EMAC_Debug_TPESTS_Pos)                /*!< EMAC_T::Debug: TPESTS Mask             */

#define EMAC_Debug_TFCSTS_Pos               (17)                                            /*!< EMAC_T::Debug: TFCSTS Position         */
#define EMAC_Debug_TFCSTS_Msk               (0x3ul << EMAC_Debug_TFCSTS_Pos)                /*!< EMAC_T::Debug: TFCSTS Mask             */

#define EMAC_Debug_TXPAUSED_Pos             (19)                                            /*!< EMAC_T::Debug: TXPAUSED Position       */
#define EMAC_Debug_TXPAUSED_Msk             (0x1ul << EMAC_Debug_TXPAUSED_Pos)              /*!< EMAC_T::Debug: TXPAUSED Mask           */

#define EMAC_Debug_TRCSTS_Pos               (20)                                            /*!< EMAC_T::Debug: TRCSTS Position         */
#define EMAC_Debug_TRCSTS_Msk               (0x3ul << EMAC_Debug_TRCSTS_Pos)                /*!< EMAC_T::Debug: TRCSTS Mask             */

#define EMAC_Debug_TWCSTS_Pos               (22)                                            /*!< EMAC_T::Debug: TWCSTS Position         */
#define EMAC_Debug_TWCSTS_Msk               (0x1ul << EMAC_Debug_TWCSTS_Pos)                /*!< EMAC_T::Debug: TWCSTS Mask             */

#define EMAC_Debug_TXFSTS_Pos               (24)                                            /*!< EMAC_T::Debug: TXFSTS Position         */
#define EMAC_Debug_TXFSTS_Msk               (0x1ul << EMAC_Debug_TXFSTS_Pos)                /*!< EMAC_T::Debug: TXFSTS Mask             */

#define EMAC_Debug_TXSTSFSTS_Pos            (25)                                            /*!< EMAC_T::Debug: TXSTSFSTS Position      */
#define EMAC_Debug_TXSTSFSTS_Msk            (0x1ul << EMAC_Debug_TXSTSFSTS_Pos)             /*!< EMAC_T::Debug: TXSTSFSTS Mask          */

#define EMAC_PmtCtrlStatus_PWRDWN_Pos       (0)                                             /*!< EMAC_T::PmtCtrlStatus: PWRDWN Position*/
#define EMAC_PmtCtrlStatus_PWRDWN_Msk       (0x1ul << EMAC_PmtCtrlStatus_PWRDWN_Pos)        /*!< EMAC_T::PmtCtrlStatus: PWRDWN Mask    */

#define EMAC_PmtCtrlStatus_MGKPKTEN_Pos     (1)                                             /*!< EMAC_T::PmtCtrlStatus: MGKPKTEN Position*/
#define EMAC_PmtCtrlStatus_MGKPKTEN_Msk     (0x1ul << EMAC_PmtCtrlStatus_MGKPKTEN_Pos)      /*!< EMAC_T::PmtCtrlStatus: MGKPKTEN Mask  */

#define EMAC_PmtCtrlStatus_MGKPRCVD_Pos     (5)                                             /*!< EMAC_T::PmtCtrlStatus: MGKPRCVD Position*/
#define EMAC_PmtCtrlStatus_MGKPRCVD_Msk     (0x1ul << EMAC_PmtCtrlStatus_MGKPRCVD_Pos)      /*!< EMAC_T::PmtCtrlStatus: MGKPRCVD Mask  */

#define EMAC_LpiCtrlStatus_TLPIEN_Pos       (0)                                             /*!< EMAC_T::LpiCtrlStatus: TLPIEN Position*/
#define EMAC_LpiCtrlStatus_TLPIEN_Msk       (0x1ul << EMAC_LpiCtrlStatus_TLPIEN_Pos)        /*!< EMAC_T::LpiCtrlStatus: TLPIEN Mask    */

#define EMAC_LpiCtrlStatus_TLPIEX_Pos       (1)                                             /*!< EMAC_T::LpiCtrlStatus: TLPIEX Position*/
#define EMAC_LpiCtrlStatus_TLPIEX_Msk       (0x1ul << EMAC_LpiCtrlStatus_TLPIEX_Pos)        /*!< EMAC_T::LpiCtrlStatus: TLPIEX Mask    */

#define EMAC_LpiCtrlStatus_RLPIEN_Pos       (2)                                             /*!< EMAC_T::LpiCtrlStatus: RLPIEN Position*/
#define EMAC_LpiCtrlStatus_RLPIEN_Msk       (0x1ul << EMAC_LpiCtrlStatus_RLPIEN_Pos)        /*!< EMAC_T::LpiCtrlStatus: RLPIEN Mask    */

#define EMAC_LpiCtrlStatus_RLPIEX_Pos       (3)                                             /*!< EMAC_T::LpiCtrlStatus: RLPIEX Position*/
#define EMAC_LpiCtrlStatus_RLPIEX_Msk       (0x1ul << EMAC_LpiCtrlStatus_RLPIEX_Pos)        /*!< EMAC_T::LpiCtrlStatus: RLPIEX Mask    */

#define EMAC_LpiCtrlStatus_TLPIST_Pos       (8)                                             /*!< EMAC_T::LpiCtrlStatus: TLPIST Position*/
#define EMAC_LpiCtrlStatus_TLPIST_Msk       (0x1ul << EMAC_LpiCtrlStatus_TLPIST_Pos)        /*!< EMAC_T::LpiCtrlStatus: TLPIST Mask    */

#define EMAC_LpiCtrlStatus_RLPIST_Pos       (9)                                             /*!< EMAC_T::LpiCtrlStatus: RLPIST Position*/
#define EMAC_LpiCtrlStatus_RLPIST_Msk       (0x1ul << EMAC_LpiCtrlStatus_RLPIST_Pos)        /*!< EMAC_T::LpiCtrlStatus: RLPIST Mask    */

#define EMAC_LpiCtrlStatus_LPIEN_Pos        (16)                                            /*!< EMAC_T::LpiCtrlStatus: LPIEN Position */
#define EMAC_LpiCtrlStatus_LPIEN_Msk        (0x1ul << EMAC_LpiCtrlStatus_LPIEN_Pos)         /*!< EMAC_T::LpiCtrlStatus: LPIEN Mask     */

#define EMAC_LpiCtrlStatus_PLS_Pos          (17)                                            /*!< EMAC_T::LpiCtrlStatus: PLS Position   */
#define EMAC_LpiCtrlStatus_PLS_Msk          (0x1ul << EMAC_LpiCtrlStatus_PLS_Pos)           /*!< EMAC_T::LpiCtrlStatus: PLS Mask       */

#define EMAC_LpiCtrlStatus_PLSEN_Pos        (18)                                            /*!< EMAC_T::LpiCtrlStatus: PLSEN Position */
#define EMAC_LpiCtrlStatus_PLSEN_Msk        (0x1ul << EMAC_LpiCtrlStatus_PLSEN_Pos)         /*!< EMAC_T::LpiCtrlStatus: PLSEN Mask     */

#define EMAC_LpiCtrlStatus_LPITXA_Pos       (19)                                            /*!< EMAC_T::LpiCtrlStatus: LPITXA Position*/
#define EMAC_LpiCtrlStatus_LPITXA_Msk       (0x1ul << EMAC_LpiCtrlStatus_LPITXA_Pos)        /*!< EMAC_T::LpiCtrlStatus: LPITXA Mask    */

#define EMAC_LpiTimerCtrl_TWT_Pos           (0)                                             /*!< EMAC_T::LpiTimerCtrl: TWT Position   */
#define EMAC_LpiTimerCtrl_TWT_Msk           (0xfffful << EMAC_LpiTimerCtrl_TWT_Pos)         /*!< EMAC_T::LpiTimerCtrl: TWT Mask       */

#define EMAC_LpiTimerCtrl_LST_Pos           (16)                                            /*!< EMAC_T::LpiTimerCtrl: LST Position   */
#define EMAC_LpiTimerCtrl_LST_Msk           (0x3fful << EMAC_LpiTimerCtrl_LST_Pos)          /*!< EMAC_T::LpiTimerCtrl: LST Mask       */

#define EMAC_IntStatus_RGSMIIIS_Pos         (0)                                             /*!< EMAC_T::IntStatus: RGSMIIIS Position      */
#define EMAC_IntStatus_RGSMIIIS_Msk         (0x1ul << EMAC_IntStatus_RGSMIIIS_Pos)          /*!< EMAC_T::IntStatus: RGSMIIIS Mask          */

#define EMAC_IntStatus_PMTIS_Pos            (3)                                             /*!< EMAC_T::IntStatus: PMTIS Position         */
#define EMAC_IntStatus_PMTIS_Msk            (0x1ul << EMAC_IntStatus_PMTIS_Pos)             /*!< EMAC_T::IntStatus: PMTIS Mask             */

#define EMAC_IntStatus_TSIS_Pos             (9)                                             /*!< EMAC_T::IntStatus: TSIS Position          */
#define EMAC_IntStatus_TSIS_Msk             (0x1ul << EMAC_IntStatus_TSIS_Pos)              /*!< EMAC_T::IntStatus: TSIS Mask              */

#define EMAC_IntStatus_LPIIS_Pos            (10)                                            /*!< EMAC_T::IntStatus: LPIIS Position         */
#define EMAC_IntStatus_LPIIS_Msk            (0x1ul << EMAC_IntStatus_LPIIS_Pos)             /*!< EMAC_T::IntStatus: LPIIS Mask             */

#define EMAC_IntMask_RGSMIIIM_Pos           (0)                                             /*!< EMAC_T::IntMask: RGSMIIIM Position        */
#define EMAC_IntMask_RGSMIIIM_Msk           (0x1ul << EMAC_IntMask_RGSMIIIM_Pos)            /*!< EMAC_T::IntMask: RGSMIIIM Mask            */

#define EMAC_IntMask_PCSLCHGIM_Pos          (1)                                             /*!< EMAC_T::IntMask: PCSLCHGIM Position       */
#define EMAC_IntMask_PCSLCHGIM_Msk          (0x1ul << EMAC_IntMask_PCSLCHGIM_Pos)           /*!< EMAC_T::IntMask: PCSLCHGIM Mask           */

#define EMAC_IntMask_PCSANCIM_Pos           (2)                                             /*!< EMAC_T::IntMask: PCSANCIM Position        */
#define EMAC_IntMask_PCSANCIM_Msk           (0x1ul << EMAC_IntMask_PCSANCIM_Pos)            /*!< EMAC_T::IntMask: PCSANCIM Mask            */

#define EMAC_IntMask_PMTIM_Pos              (3)                                             /*!< EMAC_T::IntMask: PMTIM Position           */
#define EMAC_IntMask_PMTIM_Msk              (0x1ul << EMAC_IntMask_PMTIM_Pos)               /*!< EMAC_T::IntMask: PMTIM Mask               */

#define EMAC_IntMask_TSIM_Pos               (9)                                             /*!< EMAC_T::IntMask: TSIM Position            */
#define EMAC_IntMask_TSIM_Msk               (0x1ul << EMAC_IntMask_TSIM_Pos)                /*!< EMAC_T::IntMask: TSIM Mask                */

#define EMAC_IntMask_LPIIM_Pos              (10)                                            /*!< EMAC_T::IntMask: LPIIM Position           */
#define EMAC_IntMask_LPIIM_Msk              (0x1ul << EMAC_IntMask_LPIIM_Pos)               /*!< EMAC_T::IntMask: LPIIM Mask               */

#define EMAC_Addr0High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr0High: ADDRHI Position */
#define EMAC_Addr0High_ADDRHI_Msk           (0xfffful << EMAC_Addr0High_ADDRHI_Pos)         /*!< EMAC_T::Addr0High: ADDRHI Mask     */

#define EMAC_Addr0High_AE_Pos               (31)                                            /*!< EMAC_T::Addr0High: AE Position     */
#define EMAC_Addr0High_AE_Msk               (0x1ul << EMAC_Addr0High_AE_Pos)                /*!< EMAC_T::Addr0High: AE Mask         */

#define EMAC_Addr0Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr0Low: ADDRLO Position  */
#define EMAC_Addr0Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr0Low_ADDRLO_Pos)      /*!< EMAC_T::Addr0Low: ADDRLO Mask      */

#define EMAC_Addr1High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr1High: ADDRHI Position */
#define EMAC_Addr1High_ADDRHI_Msk           (0xfffful << EMAC_Addr1High_ADDRHI_Pos)         /*!< EMAC_T::Addr1High: ADDRHI Mask     */

#define EMAC_Addr1High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr1High: MBC Position    */
#define EMAC_Addr1High_MBC_Msk              (0x3ful << EMAC_Addr1High_MBC_Pos)              /*!< EMAC_T::Addr1High: MBC Mask        */

#define EMAC_Addr1High_SA_Pos               (30)                                            /*!< EMAC_T::Addr1High: SA Position     */
#define EMAC_Addr1High_SA_Msk               (0x1ul << EMAC_Addr1High_SA_Pos)                /*!< EMAC_T::Addr1High: SA Mask         */

#define EMAC_Addr1High_AE_Pos               (31)                                            /*!< EMAC_T::Addr1High: AE Position     */
#define EMAC_Addr1High_AE_Msk               (0x1ul << EMAC_Addr1High_AE_Pos)                /*!< EMAC_T::Addr1High: AE Mask         */

#define EMAC_Addr1Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr1Low: ADDRLO Position  */
#define EMAC_Addr1Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr1Low_ADDRLO_Pos)      /*!< EMAC_T::Addr1Low: ADDRLO Mask      */

#define EMAC_Addr2High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr2High: ADDRHI Position */
#define EMAC_Addr2High_ADDRHI_Msk           (0xfffful << EMAC_Addr2High_ADDRHI_Pos)         /*!< EMAC_T::Addr2High: ADDRHI Mask     */

#define EMAC_Addr2High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr2High: MBC Position    */
#define EMAC_Addr2High_MBC_Msk              (0x3ful << EMAC_Addr2High_MBC_Pos)              /*!< EMAC_T::Addr2High: MBC Mask        */

#define EMAC_Addr2High_SA_Pos               (30)                                            /*!< EMAC_T::Addr2High: SA Position     */
#define EMAC_Addr2High_SA_Msk               (0x1ul << EMAC_Addr2High_SA_Pos)                /*!< EMAC_T::Addr2High: SA Mask         */

#define EMAC_Addr2High_AE_Pos               (31)                                            /*!< EMAC_T::Addr2High: AE Position     */
#define EMAC_Addr2High_AE_Msk               (0x1ul << EMAC_Addr2High_AE_Pos)                /*!< EMAC_T::Addr2High: AE Mask         */

#define EMAC_Addr2Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr2Low: ADDRLO Position  */
#define EMAC_Addr2Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr2Low_ADDRLO_Pos)      /*!< EMAC_T::Addr2Low: ADDRLO Mask      */

#define EMAC_Addr3High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr3High: ADDRHI Position */
#define EMAC_Addr3High_ADDRHI_Msk           (0xfffful << EMAC_Addr3High_ADDRHI_Pos)         /*!< EMAC_T::Addr3High: ADDRHI Mask     */

#define EMAC_Addr3High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr3High: MBC Position    */
#define EMAC_Addr3High_MBC_Msk              (0x3ful << EMAC_Addr3High_MBC_Pos)              /*!< EMAC_T::Addr3High: MBC Mask        */

#define EMAC_Addr3High_SA_Pos               (30)                                            /*!< EMAC_T::Addr3High: SA Position     */
#define EMAC_Addr3High_SA_Msk               (0x1ul << EMAC_Addr3High_SA_Pos)                /*!< EMAC_T::Addr3High: SA Mask         */

#define EMAC_Addr3High_AE_Pos               (31)                                            /*!< EMAC_T::Addr3High: AE Position     */
#define EMAC_Addr3High_AE_Msk               (0x1ul << EMAC_Addr3High_AE_Pos)                /*!< EMAC_T::Addr3High: AE Mask         */

#define EMAC_Addr3Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr3Low: ADDRLO Position  */
#define EMAC_Addr3Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr3Low_ADDRLO_Pos)      /*!< EMAC_T::Addr3Low: ADDRLO Mask      */

#define EMAC_Addr4High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr4High: ADDRHI Position */
#define EMAC_Addr4High_ADDRHI_Msk           (0xfffful << EMAC_Addr4High_ADDRHI_Pos)         /*!< EMAC_T::Addr4High: ADDRHI Mask     */

#define EMAC_Addr4High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr4High: MBC Position    */
#define EMAC_Addr4High_MBC_Msk              (0x3ful << EMAC_Addr4High_MBC_Pos)              /*!< EMAC_T::Addr4High: MBC Mask        */

#define EMAC_Addr4High_SA_Pos               (30)                                            /*!< EMAC_T::Addr4High: SA Position     */
#define EMAC_Addr4High_SA_Msk               (0x1ul << EMAC_Addr4High_SA_Pos)                /*!< EMAC_T::Addr4High: SA Mask         */

#define EMAC_Addr4High_AE_Pos               (31)                                            /*!< EMAC_T::Addr4High: AE Position     */
#define EMAC_Addr4High_AE_Msk               (0x1ul << EMAC_Addr4High_AE_Pos)                /*!< EMAC_T::Addr4High: AE Mask         */

#define EMAC_Addr4Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr4Low: ADDRLO Position  */
#define EMAC_Addr4Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr4Low_ADDRLO_Pos)      /*!< EMAC_T::Addr4Low: ADDRLO Mask      */

#define EMAC_Addr5High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr5High: ADDRHI Position */
#define EMAC_Addr5High_ADDRHI_Msk           (0xfffful << EMAC_Addr5High_ADDRHI_Pos)         /*!< EMAC_T::Addr5High: ADDRHI Mask     */

#define EMAC_Addr5High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr5High: MBC Position    */
#define EMAC_Addr5High_MBC_Msk              (0x3ful << EMAC_Addr5High_MBC_Pos)              /*!< EMAC_T::Addr5High: MBC Mask        */

#define EMAC_Addr5High_SA_Pos               (30)                                            /*!< EMAC_T::Addr5High: SA Position     */
#define EMAC_Addr5High_SA_Msk               (0x1ul << EMAC_Addr5High_SA_Pos)                /*!< EMAC_T::Addr5High: SA Mask         */

#define EMAC_Addr5High_AE_Pos               (31)                                            /*!< EMAC_T::Addr5High: AE Position     */
#define EMAC_Addr5High_AE_Msk               (0x1ul << EMAC_Addr5High_AE_Pos)                /*!< EMAC_T::Addr5High: AE Mask         */

#define EMAC_Addr5Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr5Low: ADDRLO Position  */
#define EMAC_Addr5Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr5Low_ADDRLO_Pos)      /*!< EMAC_T::Addr5Low: ADDRLO Mask      */

#define EMAC_Addr6High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr6High: ADDRHI Position */
#define EMAC_Addr6High_ADDRHI_Msk           (0xfffful << EMAC_Addr6High_ADDRHI_Pos)         /*!< EMAC_T::Addr6High: ADDRHI Mask     */

#define EMAC_Addr6High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr6High: MBC Position    */
#define EMAC_Addr6High_MBC_Msk              (0x3ful << EMAC_Addr6High_MBC_Pos)              /*!< EMAC_T::Addr6High: MBC Mask        */

#define EMAC_Addr6High_SA_Pos               (30)                                            /*!< EMAC_T::Addr6High: SA Position     */
#define EMAC_Addr6High_SA_Msk               (0x1ul << EMAC_Addr6High_SA_Pos)                /*!< EMAC_T::Addr6High: SA Mask         */

#define EMAC_Addr6High_AE_Pos               (31)                                            /*!< EMAC_T::Addr6High: AE Position     */
#define EMAC_Addr6High_AE_Msk               (0x1ul << EMAC_Addr6High_AE_Pos)                /*!< EMAC_T::Addr6High: AE Mask         */

#define EMAC_Addr6Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr6Low: ADDRLO Position  */
#define EMAC_Addr6Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr6Low_ADDRLO_Pos)      /*!< EMAC_T::Addr6Low: ADDRLO Mask      */

#define EMAC_Addr7High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr7High: ADDRHI Position */
#define EMAC_Addr7High_ADDRHI_Msk           (0xfffful << EMAC_Addr7High_ADDRHI_Pos)         /*!< EMAC_T::Addr7High: ADDRHI Mask     */

#define EMAC_Addr7High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr7High: MBC Position    */
#define EMAC_Addr7High_MBC_Msk              (0x3ful << EMAC_Addr7High_MBC_Pos)              /*!< EMAC_T::Addr7High: MBC Mask        */

#define EMAC_Addr7High_SA_Pos               (30)                                            /*!< EMAC_T::Addr7High: SA Position     */
#define EMAC_Addr7High_SA_Msk               (0x1ul << EMAC_Addr7High_SA_Pos)                /*!< EMAC_T::Addr7High: SA Mask         */

#define EMAC_Addr7High_AE_Pos               (31)                                            /*!< EMAC_T::Addr7High: AE Position     */
#define EMAC_Addr7High_AE_Msk               (0x1ul << EMAC_Addr7High_AE_Pos)                /*!< EMAC_T::Addr7High: AE Mask         */

#define EMAC_Addr7Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr7Low: ADDRLO Position  */
#define EMAC_Addr7Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr7Low_ADDRLO_Pos)      /*!< EMAC_T::Addr7Low: ADDRLO Mask      */

#define EMAC_Addr8High_ADDRHI_Pos           (0)                                             /*!< EMAC_T::Addr8High: ADDRHI Position */
#define EMAC_Addr8High_ADDRHI_Msk           (0xfffful << EMAC_Addr8High_ADDRHI_Pos)         /*!< EMAC_T::Addr8High: ADDRHI Mask     */

#define EMAC_Addr8High_MBC_Pos              (24)                                            /*!< EMAC_T::Addr8High: MBC Position    */
#define EMAC_Addr8High_MBC_Msk              (0x3ful << EMAC_Addr8High_MBC_Pos)              /*!< EMAC_T::Addr8High: MBC Mask        */

#define EMAC_Addr8High_SA_Pos               (30)                                            /*!< EMAC_T::Addr8High: SA Position     */
#define EMAC_Addr8High_SA_Msk               (0x1ul << EMAC_Addr8High_SA_Pos)                /*!< EMAC_T::Addr8High: SA Mask         */

#define EMAC_Addr8High_AE_Pos               (31)                                            /*!< EMAC_T::Addr8High: AE Position     */
#define EMAC_Addr8High_AE_Msk               (0x1ul << EMAC_Addr8High_AE_Pos)                /*!< EMAC_T::Addr8High: AE Mask         */

#define EMAC_Addr8Low_ADDRLO_Pos            (0)                                             /*!< EMAC_T::Addr8Low: ADDRLO Position  */
#define EMAC_Addr8Low_ADDRLO_Msk            (0xfffffffful << EMAC_Addr8Low_ADDRLO_Pos)      /*!< EMAC_T::Addr8Low: ADDRLO Mask      */

#define EMAC_RgmiiCtrlSts_LNKMOD_Pos        (0)                                             /*!< EMAC_T::RgmiiCtrlSts: LNKMOD Position*/
#define EMAC_RgmiiCtrlSts_LNKMOD_Msk        (0x1ul << EMAC_RgmiiCtrlSts_LNKMOD_Pos)         /*!< EMAC_T::RgmiiCtrlSts: LNKMOD Mask    */

#define EMAC_RgmiiCtrlSts_LNKSPEED_Pos      (1)                                             /*!< EMAC_T::RgmiiCtrlSts: LNKSPEED Position*/
#define EMAC_RgmiiCtrlSts_LNKSPEED_Msk      (0x3ul << EMAC_RgmiiCtrlSts_LNKSPEED_Pos)       /*!< EMAC_T::RgmiiCtrlSts: LNKSPEED Mask  */

#define EMAC_RgmiiCtrlSts_LNKSTS_Pos        (3)                                             /*!< EMAC_T::RgmiiCtrlSts: LNKSTS Position*/
#define EMAC_RgmiiCtrlSts_LNKSTS_Msk        (0x1ul << EMAC_RgmiiCtrlSts_LNKSTS_Pos)         /*!< EMAC_T::RgmiiCtrlSts: LNKSTS Mask    */

#define EMAC_Timeout_WTO_Pos                (0)                                             /*!< EMAC_T::Timeout: WTO Position          */
#define EMAC_Timeout_WTO_Msk                (0x3ffful << EMAC_Timeout_WTO_Pos)              /*!< EMAC_T::Timeout: WTO Mask              */

#define EMAC_Timeout_PWE_Pos                (16)                                            /*!< EMAC_T::Timeout: PWE Position          */
#define EMAC_Timeout_PWE_Msk                (0x1ul << EMAC_Timeout_PWE_Pos)                 /*!< EMAC_T::Timeout: PWE Mask              */

#define EMAC_VlanIncRep_VLT_Pos             (0)                                             /*!< EMAC_T::VlanIncRep: VLT Position         */
#define EMAC_VlanIncRep_VLT_Msk             (0xfffful << EMAC_VlanIncRep_VLT_Pos)           /*!< EMAC_T::VlanIncRep: VLT Mask             */

#define EMAC_VlanIncRep_VLC_Pos             (16)                                            /*!< EMAC_T::VlanIncRep: VLC Position         */
#define EMAC_VlanIncRep_VLC_Msk             (0x3ul << EMAC_VlanIncRep_VLC_Pos)              /*!< EMAC_T::VlanIncRep: VLC Mask             */

#define EMAC_VlanIncRep_VLP_Pos             (18)                                            /*!< EMAC_T::VlanIncRep: VLP Position         */
#define EMAC_VlanIncRep_VLP_Msk             (0x1ul << EMAC_VlanIncRep_VLP_Pos)              /*!< EMAC_T::VlanIncRep: VLP Mask             */

#define EMAC_VlanIncRep_CSVL_Pos            (19)                                            /*!< EMAC_T::VlanIncRep: CSVL Position        */
#define EMAC_VlanIncRep_CSVL_Msk            (0x1ul << EMAC_VlanIncRep_CSVL_Pos)             /*!< EMAC_T::VlanIncRep: CSVL Mask            */

#define EMAC_TSControl_TSENA_Pos            (0)                                             /*!< EMAC_T::TSControl: TSENA Position        */
#define EMAC_TSControl_TSENA_Msk            (0x1ul << EMAC_TSControl_TSENA_Pos)             /*!< EMAC_T::TSControl: TSENA Mask            */

#define EMAC_TSControl_TSCFUPDT_Pos         (1)                                             /*!< EMAC_T::TSControl: TSCFUPDT Position     */
#define EMAC_TSControl_TSCFUPDT_Msk         (0x1ul << EMAC_TSControl_TSCFUPDT_Pos)          /*!< EMAC_T::TSControl: TSCFUPDT Mask         */

#define EMAC_TSControl_TSINIT_Pos           (2)                                             /*!< EMAC_T::TSControl: TSINIT Position       */
#define EMAC_TSControl_TSINIT_Msk           (0x1ul << EMAC_TSControl_TSINIT_Pos)            /*!< EMAC_T::TSControl: TSINIT Mask           */

#define EMAC_TSControl_TSUPDT_Pos           (3)                                             /*!< EMAC_T::TSControl: TSUPDT Position       */
#define EMAC_TSControl_TSUPDT_Msk           (0x1ul << EMAC_TSControl_TSUPDT_Pos)            /*!< EMAC_T::TSControl: TSUPDT Mask           */

#define EMAC_TSControl_TSTRIG_Pos           (4)                                             /*!< EMAC_T::TSControl: TSTRIG Position       */
#define EMAC_TSControl_TSTRIG_Msk           (0x1ul << EMAC_TSControl_TSTRIG_Pos)            /*!< EMAC_T::TSControl: TSTRIG Mask           */

#define EMAC_TSControl_TSADDREG_Pos         (5)                                             /*!< EMAC_T::TSControl: TSADDREG Position     */
#define EMAC_TSControl_TSADDREG_Msk         (0x1ul << EMAC_TSControl_TSADDREG_Pos)          /*!< EMAC_T::TSControl: TSADDREG Mask         */

#define EMAC_TSControl_TSENALL_Pos          (8)                                             /*!< EMAC_T::TSControl: TSENALL Position      */
#define EMAC_TSControl_TSENALL_Msk          (0x1ul << EMAC_TSControl_TSENALL_Pos)           /*!< EMAC_T::TSControl: TSENALL Mask          */

#define EMAC_TSControl_TSCTRLSSR_Pos        (9)                                             /*!< EMAC_T::TSControl: TSCTRLSSR Position    */
#define EMAC_TSControl_TSCTRLSSR_Msk        (0x1ul << EMAC_TSControl_TSCTRLSSR_Pos)         /*!< EMAC_T::TSControl: TSCTRLSSR Mask        */

#define EMAC_TSControl_TSVER2ENA_Pos        (10)                                            /*!< EMAC_T::TSControl: TSVER2ENA Position    */
#define EMAC_TSControl_TSVER2ENA_Msk        (0x1ul << EMAC_TSControl_TSVER2ENA_Pos)         /*!< EMAC_T::TSControl: TSVER2ENA Mask        */

#define EMAC_TSControl_TSIPENA_Pos          (11)                                            /*!< EMAC_T::TSControl: TSIPENA Position      */
#define EMAC_TSControl_TSIPENA_Msk          (0x1ul << EMAC_TSControl_TSIPENA_Pos)           /*!< EMAC_T::TSControl: TSIPENA Mask          */

#define EMAC_TSControl_TSIPV6ENA_Pos        (12)                                            /*!< EMAC_T::TSControl: TSIPV6ENA Position    */
#define EMAC_TSControl_TSIPV6ENA_Msk        (0x1ul << EMAC_TSControl_TSIPV6ENA_Pos)         /*!< EMAC_T::TSControl: TSIPV6ENA Mask        */

#define EMAC_TSControl_TSIPV4ENA_Pos        (13)                                            /*!< EMAC_T::TSControl: TSIPV4ENA Position    */
#define EMAC_TSControl_TSIPV4ENA_Msk        (0x1ul << EMAC_TSControl_TSIPV4ENA_Pos)         /*!< EMAC_T::TSControl: TSIPV4ENA Mask        */

#define EMAC_TSControl_TSEVNTENA_Pos        (14)                                            /*!< EMAC_T::TSControl: TSEVNTENA Position    */
#define EMAC_TSControl_TSEVNTENA_Msk        (0x1ul << EMAC_TSControl_TSEVNTENA_Pos)         /*!< EMAC_T::TSControl: TSEVNTENA Mask        */

#define EMAC_TSControl_TSMSTRENA_Pos        (15)                                            /*!< EMAC_T::TSControl: TSMSTRENA Position    */
#define EMAC_TSControl_TSMSTRENA_Msk        (0x1ul << EMAC_TSControl_TSMSTRENA_Pos)         /*!< EMAC_T::TSControl: TSMSTRENA Mask        */

#define EMAC_TSControl_SNAPTYPSEL_Pos       (16)                                            /*!< EMAC_T::TSControl: SNAPTYPSEL Position   */
#define EMAC_TSControl_SNAPTYPSEL_Msk       (0x3ul << EMAC_TSControl_SNAPTYPSEL_Pos)        /*!< EMAC_T::TSControl: SNAPTYPSEL Mask       */

#define EMAC_TSControl_TSENMACADDR_Pos      (18)                                            /*!< EMAC_T::TSControl: TSENMACADDR Position  */
#define EMAC_TSControl_TSENMACADDR_Msk      (0x1ul << EMAC_TSControl_TSENMACADDR_Pos)       /*!< EMAC_T::TSControl: TSENMACADDR Mask      */

#define EMAC_TSSubSecIncr_SSINC_Pos         (0)                                             /*!< EMAC_T::TSSubSecIncr: SSINC Position*/
#define EMAC_TSSubSecIncr_SSINC_Msk         (0xfful << EMAC_TSSubSecIncr_SSINC_Pos)         /*!< EMAC_T::TSSubSecIncr: SSINC Mask   */

#define EMAC_TSSec_TSS_Pos                  (0)                                             /*!< EMAC_T::TSSec: TSS Position     */
#define EMAC_TSSec_TSS_Msk                  (0xfffffffful << EMAC_TSSec_TSS_Pos)            /*!< EMAC_T::TSSec: TSS Mask         */

#define EMAC_TSNanosec_TSSS_Pos             (0)                                             /*!< EMAC_T::TSNanosec: TSSS Position*/
#define EMAC_TSNanosec_TSSS_Msk             (0x7ffffffful << EMAC_TSNanosec_TSSS_Pos)       /*!< EMAC_T::TSNanosec: TSSS Mask    */

#define EMAC_TSSecUpdate_TSS_Pos            (0)                                             /*!< EMAC_T::TSSecUpdate: TSS Position*/
#define EMAC_TSSecUpdate_TSS_Msk            (0xfffffffful << EMAC_TSSecUpdate_TSS_Pos)      /*!< EMAC_T::TSSecUpdate: TSS Mask  */

#define EMAC_TSNanosecUpdate_TSSS_Pos       (0)                                             /*!< EMAC_T::TSNanosecUpdate: TSSS Position*/
#define EMAC_TSNanosecUpdate_TSSS_Msk       (0x7ffffffful << EMAC_TSNanosecUpdate_TSSS_Pos) /*!< EMAC_T::TSNanosecUpdate: TSSS Mask*/

#define EMAC_TSNanosecUpdate_ADDSUB_Pos     (31)                                            /*!< EMAC_T::TSNanosecUpdate: ADDSUB Position*/
#define EMAC_TSNanosecUpdate_ADDSUB_Msk     (0x1ul << EMAC_TSNanosecUpdate_ADDSUB_Pos)      /*!< EMAC_T::TSNanosecUpdate: ADDSUB Mask*/

#define EMAC_TSAddend_TSAR_Pos              (0)                                             /*!< EMAC_T::TSAddend: TSAR Position          */
#define EMAC_TSAddend_TSAR_Msk              (0xfffffffful << EMAC_TSAddend_TSAR_Pos)        /*!< EMAC_T::TSAddend: TSAR Mask              */

#define EMAC_TSTargetSec_TSTR_Pos           (0)                                             /*!< EMAC_T::TSTargetSec: TSTR Position    */
#define EMAC_TSTargetSec_TSTR_Msk           (0xfffffffful << EMAC_TSTargetSec_TSTR_Pos)     /*!< EMAC_T::TSTargetSec: TSTR Mask        */

#define EMAC_TSTargetNanosec_TTSLO_Pos      (0)                                             /*!< EMAC_T::TSTargetNanosec: TTSLO Position*/
#define EMAC_TSTargetNanosec_TTSLO_Msk      (0x7ffffffful << EMAC_TSTargetNanosec_TTSLO_Pos)/*!< EMAC_T::TSTargetNanosec: TTSLO Mask   */

#define EMAC_TSTargetNanosec_TRGTBUSY_Pos   (31)                                            /*!< EMAC_T::TSTargetNanosec: TRGTBUSY Position*/
#define EMAC_TSTargetNanosec_TRGTBUSY_Msk   (0x1ul << EMAC_TSTargetNanosec_TRGTBUSY_Pos)    /*!< EMAC_T::TSTargetNanosec: TRGTBUSY Mask*/

#define EMAC_TSSecHigher_TSHWR_Pos          (0)                                             /*!< EMAC_T::TSSecHigher: TSHWR Position*/
#define EMAC_TSSecHigher_TSHWR_Msk          (0xfffful << EMAC_TSSecHigher_TSHWR_Pos)        /*!< EMAC_T::TSSecHigher: TSHWR Mask*/

#define EMAC_TSStatus_TSSOVF_Pos            (0)                                             /*!< EMAC_T::TSStatus: TSSOVF Position        */
#define EMAC_TSStatus_TSSOVF_Msk            (0x1ul << EMAC_TSStatus_TSSOVF_Pos)             /*!< EMAC_T::TSStatus: TSSOVF Mask            */

#define EMAC_TSStatus_TSTARGT_Pos           (1)                                             /*!< EMAC_T::TSStatus: TSTARGT Position       */
#define EMAC_TSStatus_TSTARGT_Msk           (0x1ul << EMAC_TSStatus_TSTARGT_Pos)            /*!< EMAC_T::TSStatus: TSTARGT Mask           */

#define EMAC_TSStatus_AUXTSTRIG_Pos         (2)                                             /*!< EMAC_T::TSStatus: AUXTSTRIG Position     */
#define EMAC_TSStatus_AUXTSTRIG_Msk         (0x1ul << EMAC_TSStatus_AUXTSTRIG_Pos)          /*!< EMAC_T::TSStatus: AUXTSTRIG Mask         */

#define EMAC_TSStatus_TSTRGTERR_Pos         (3)                                             /*!< EMAC_T::TSStatus: TSTRGTERR Position     */
#define EMAC_TSStatus_TSTRGTERR_Msk         (0x1ul << EMAC_TSStatus_TSTRGTERR_Pos)          /*!< EMAC_T::TSStatus: TSTRGTERR Mask         */

#define EMAC_TSStatus_ATSSTN_Pos            (16)                                            /*!< EMAC_T::TSStatus: ATSSTN Position        */
#define EMAC_TSStatus_ATSSTN_Msk            (0xful << EMAC_TSStatus_ATSSTN_Pos)             /*!< EMAC_T::TSStatus: ATSSTN Mask            */

#define EMAC_PPSCtrl_PPSCTRL_PPSCMD_Pos     (0)                                             /*!< EMAC_T::PPSCtrl: PPSCTRL_PPSCMD Position*/
#define EMAC_PPSCtrl_PPSCTRL_PPSCMD_Msk     (0xful << EMAC_PPSCtrl_PPSCTRL_PPSCMD_Pos)      /*!< EMAC_T::PPSCtrl: PPSCTRL_PPSCMD Mask   */

#define EMAC_PPSCtrl_PPSEN0_Pos             (4)                                             /*!< EMAC_T::PPSCtrl: PPSEN0 Position       */
#define EMAC_PPSCtrl_PPSEN0_Msk             (0x1ul << EMAC_PPSCtrl_PPSEN0_Pos)              /*!< EMAC_T::PPSCtrl: PPSEN0 Mask           */

#define EMAC_PPSCtrl_TRGTMODSEL0_Pos        (5)                                             /*!< EMAC_T::PPSCtrl: TRGTMODSEL0 Position  */
#define EMAC_PPSCtrl_TRGTMODSEL0_Msk        (0x3ul << EMAC_PPSCtrl_TRGTMODSEL0_Pos)         /*!< EMAC_T::PPSCtrl: TRGTMODSEL0 Mask      */

#define EMAC_PPSInterval_PPSINT_Pos         (0)                                             /*!< EMAC_T::PPSInterval: PPSINT Position      */
#define EMAC_PPSInterval_PPSINT_Msk         (0xfffffffful << EMAC_PPSInterval_PPSINT_Pos)   /*!< EMAC_T::PPSInterval: PPSINT Mask          */

#define EMAC_PPSWidth_PPSWIDTH_Pos          (0)                                             /*!< EMAC_T::PPSWidth: PPSWIDTH Position       */
#define EMAC_PPSWidth_PPSWIDTH_Msk          (0xfffffffful << EMAC_PPSWidth_PPSWIDTH_Pos)    /*!< EMAC_T::PPSWidth: PPSWIDTH Mask           */

#define EMAC_DmaBusMode_SWR_Pos             (0)                                             /*!< EMAC_T::DmaBusMode: SWR Position             */
#define EMAC_DmaBusMode_SWR_Msk             (0x1ul << EMAC_DmaBusMode_SWR_Pos)              /*!< EMAC_T::DmaBusMode: SWR Mask                 */

#define EMAC_DmaBusMode_DSL_Pos             (2)                                             /*!< EMAC_T::DmaBusMode: DSL Position             */
#define EMAC_DmaBusMode_DSL_Msk             (0x1ful << EMAC_DmaBusMode_DSL_Pos)             /*!< EMAC_T::DmaBusMode: DSL Mask                 */

#define EMAC_DmaBusMode_ATDS_Pos            (7)                                             /*!< EMAC_T::DmaBusMode: ATDS Position            */
#define EMAC_DmaBusMode_ATDS_Msk            (0x1ul << EMAC_DmaBusMode_ATDS_Pos)             /*!< EMAC_T::DmaBusMode: ATDS Mask                */

#define EMAC_DmaBusMode_PBL_Pos             (8)                                             /*!< EMAC_T::DmaBusMode: PBL Position             */
#define EMAC_DmaBusMode_PBL_Msk             (0x3ful << EMAC_DmaBusMode_PBL_Pos)             /*!< EMAC_T::DmaBusMode: PBL Mask                 */

#define EMAC_DmaBusMode_FB_Pos              (16)                                            /*!< EMAC_T::DmaBusMode: FB Position              */
#define EMAC_DmaBusMode_FB_Msk              (0x1ul << EMAC_DmaBusMode_FB_Pos)               /*!< EMAC_T::DmaBusMode: FB Mask                  */

#define EMAC_DmaBusMode_RPBL_Pos            (17)                                            /*!< EMAC_T::DmaBusMode: RPBL Position            */
#define EMAC_DmaBusMode_RPBL_Msk            (0x3ful << EMAC_DmaBusMode_RPBL_Pos)            /*!< EMAC_T::DmaBusMode: RPBL Mask                */

#define EMAC_DmaBusMode_USP_Pos             (23)                                            /*!< EMAC_T::DmaBusMode: USP Position             */
#define EMAC_DmaBusMode_USP_Msk             (0x1ul << EMAC_DmaBusMode_USP_Pos)              /*!< EMAC_T::DmaBusMode: USP Mask                 */

#define EMAC_DmaBusMode_PBLx8_Pos           (24)                                            /*!< EMAC_T::DmaBusMode: PBLx8 Position           */
#define EMAC_DmaBusMode_PBLx8_Msk           (0x1ul << EMAC_DmaBusMode_PBLx8_Pos)            /*!< EMAC_T::DmaBusMode: PBLx8 Mask               */

#define EMAC_DmaBusMode_AAL_Pos             (25)                                            /*!< EMAC_T::DmaBusMode: AAL Position             */
#define EMAC_DmaBusMode_AAL_Msk             (0x1ul << EMAC_DmaBusMode_AAL_Pos)              /*!< EMAC_T::DmaBusMode: AAL Mask                 */

#define EMAC_DmaTxPollDemand_TPD_Pos        (0)                                             /*!< EMAC_T::DmaTxPollDemand: TPD Position      */
#define EMAC_DmaTxPollDemand_TPD_Msk        (0xfffffffful << EMAC_DmaTxPollDemand_TPD_Pos)  /*!< EMAC_T::DmaTxPollDemand: TPD Mask          */

#define EMAC_DmaRxPollDemand_RPD_Pos        (0)                                             /*!< EMAC_T::DmaRxPollDemand: RPD Position      */
#define EMAC_DmaRxPollDemand_RPD_Msk        (0xfffffffful << EMAC_DmaRxPollDemand_RPD_Pos)  /*!< EMAC_T::DmaRxPollDemand: RPD Mask          */

#define EMAC_DmaRxDesc_RDESLA_64_bit_Pos    (3)                                             /*!< EMAC_T::DmaRxDesc: RDESLA_64_bit Position*/
#define EMAC_DmaRxDesc_RDESLA_64_bit_Msk    (0x1ffffffful << EMAC_DmaRxDesc_RDESLA_64_bit_Pos) /*!< EMAC_T::DmaRxDesc: RDESLA_64_bit Mask*/

#define EMAC_DmaTxDesc_TDESLA_64_bit_Pos    (3)                                             /*!< EMAC_T::DmaTxDesc: TDESLA_64_bit Position*/
#define EMAC_DmaTxDesc_TDESLA_64_bit_Msk    (0x1ffffffful << EMAC_DmaTxDesc_TDESLA_64_bit_Pos) /*!< EMAC_T::DmaTxDesc: TDESLA_64_bit Mask*/

#define EMAC_DmaStatus_TI_Pos               (0)                                             /*!< EMAC_T::DmaStatus: TI Position            */
#define EMAC_DmaStatus_TI_Msk               (0x1ul << EMAC_DmaStatus_TI_Pos)                /*!< EMAC_T::DmaStatus: TI Mask                */

#define EMAC_DmaStatus_TPS_Pos              (1)                                             /*!< EMAC_T::DmaStatus: TPS Position           */
#define EMAC_DmaStatus_TPS_Msk              (0x1ul << EMAC_DmaStatus_TPS_Pos)               /*!< EMAC_T::DmaStatus: TPS Mask               */

#define EMAC_DmaStatus_TU_Pos               (2)                                             /*!< EMAC_T::DmaStatus: TU Position            */
#define EMAC_DmaStatus_TU_Msk               (0x1ul << EMAC_DmaStatus_TU_Pos)                /*!< EMAC_T::DmaStatus: TU Mask                */

#define EMAC_DmaStatus_TJT_Pos              (3)                                             /*!< EMAC_T::DmaStatus: TJT Position           */
#define EMAC_DmaStatus_TJT_Msk              (0x1ul << EMAC_DmaStatus_TJT_Pos)               /*!< EMAC_T::DmaStatus: TJT Mask               */

#define EMAC_DmaStatus_OVF_Pos              (4)                                             /*!< EMAC_T::DmaStatus: OVF Position           */
#define EMAC_DmaStatus_OVF_Msk              (0x1ul << EMAC_DmaStatus_OVF_Pos)               /*!< EMAC_T::DmaStatus: OVF Mask               */

#define EMAC_DmaStatus_UNF_Pos              (5)                                             /*!< EMAC_T::DmaStatus: UNF Position           */
#define EMAC_DmaStatus_UNF_Msk              (0x1ul << EMAC_DmaStatus_UNF_Pos)               /*!< EMAC_T::DmaStatus: UNF Mask               */

#define EMAC_DmaStatus_RI_Pos               (6)                                             /*!< EMAC_T::DmaStatus: RI Position            */
#define EMAC_DmaStatus_RI_Msk               (0x1ul << EMAC_DmaStatus_RI_Pos)                /*!< EMAC_T::DmaStatus: RI Mask                */

#define EMAC_DmaStatus_RU_Pos               (7)                                             /*!< EMAC_T::DmaStatus: RU Position            */
#define EMAC_DmaStatus_RU_Msk               (0x1ul << EMAC_DmaStatus_RU_Pos)                /*!< EMAC_T::DmaStatus: RU Mask                */

#define EMAC_DmaStatus_RPS_Pos              (8)                                             /*!< EMAC_T::DmaStatus: RPS Position           */
#define EMAC_DmaStatus_RPS_Msk              (0x1ul << EMAC_DmaStatus_RPS_Pos)               /*!< EMAC_T::DmaStatus: RPS Mask               */

#define EMAC_DmaStatus_RWT_Pos              (9)                                             /*!< EMAC_T::DmaStatus: RWT Position           */
#define EMAC_DmaStatus_RWT_Msk              (0x1ul << EMAC_DmaStatus_RWT_Pos)               /*!< EMAC_T::DmaStatus: RWT Mask               */

#define EMAC_DmaStatus_ETI_Pos              (10)                                            /*!< EMAC_T::DmaStatus: ETI Position           */
#define EMAC_DmaStatus_ETI_Msk              (0x1ul << EMAC_DmaStatus_ETI_Pos)               /*!< EMAC_T::DmaStatus: ETI Mask               */

#define EMAC_DmaStatus_FBI_Pos              (13)                                            /*!< EMAC_T::DmaStatus: FBI Position           */
#define EMAC_DmaStatus_FBI_Msk              (0x1ul << EMAC_DmaStatus_FBI_Pos)               /*!< EMAC_T::DmaStatus: FBI Mask               */

#define EMAC_DmaStatus_ERI_Pos              (14)                                            /*!< EMAC_T::DmaStatus: ERI Position           */
#define EMAC_DmaStatus_ERI_Msk              (0x1ul << EMAC_DmaStatus_ERI_Pos)               /*!< EMAC_T::DmaStatus: ERI Mask               */

#define EMAC_DmaStatus_AIS_Pos              (15)                                            /*!< EMAC_T::DmaStatus: AIS Position           */
#define EMAC_DmaStatus_AIS_Msk              (0x1ul << EMAC_DmaStatus_AIS_Pos)               /*!< EMAC_T::DmaStatus: AIS Mask               */

#define EMAC_DmaStatus_NIS_Pos              (16)                                            /*!< EMAC_T::DmaStatus: NIS Position           */
#define EMAC_DmaStatus_NIS_Msk              (0x1ul << EMAC_DmaStatus_NIS_Pos)               /*!< EMAC_T::DmaStatus: NIS Mask               */

#define EMAC_DmaStatus_RS_Pos               (17)                                            /*!< EMAC_T::DmaStatus: RS Position            */
#define EMAC_DmaStatus_RS_Msk               (0x7ul << EMAC_DmaStatus_RS_Pos)                /*!< EMAC_T::DmaStatus: RS Mask                */

#define EMAC_DmaStatus_TS_Pos               (20)                                            /*!< EMAC_T::DmaStatus: TS Position            */
#define EMAC_DmaStatus_TS_Msk               (0x7ul << EMAC_DmaStatus_TS_Pos)                /*!< EMAC_T::DmaStatus: TS Mask                */

#define EMAC_DmaStatus_EB_Pos               (23)                                            /*!< EMAC_T::DmaStatus: EB Position            */
#define EMAC_DmaStatus_EB_Msk               (0x7ul << EMAC_DmaStatus_EB_Pos)                /*!< EMAC_T::DmaStatus: EB Mask                */

#define EMAC_DmaStatus_GLI_Pos              (26)                                            /*!< EMAC_T::DmaStatus: GLI Position           */
#define EMAC_DmaStatus_GLI_Msk              (0x1ul << EMAC_DmaStatus_GLI_Pos)               /*!< EMAC_T::DmaStatus: GLI Mask               */

#define EMAC_DmaStatus_GPI_Pos              (28)                                            /*!< EMAC_T::DmaStatus: GPI Position           */
#define EMAC_DmaStatus_GPI_Msk              (0x1ul << EMAC_DmaStatus_GPI_Pos)               /*!< EMAC_T::DmaStatus: GPI Mask               */

#define EMAC_DmaStatus_TTI_Pos              (29)                                            /*!< EMAC_T::DmaStatus: TTI Position           */
#define EMAC_DmaStatus_TTI_Msk              (0x1ul << EMAC_DmaStatus_TTI_Pos)               /*!< EMAC_T::DmaStatus: TTI Mask               */

#define EMAC_DmaStatus_GLPII_Pos            (30)                                            /*!< EMAC_T::DmaStatus: GLPII Position         */
#define EMAC_DmaStatus_GLPII_Msk            (0x1ul << EMAC_DmaStatus_GLPII_Pos)             /*!< EMAC_T::DmaStatus: GLPII Mask             */

#define EMAC_DmaOpMode_SR_Pos               (1)                                             /*!< EMAC_T::DmaOpMode: SR Position              */
#define EMAC_DmaOpMode_SR_Msk               (0x1ul << EMAC_DmaOpMode_SR_Pos)                /*!< EMAC_T::DmaOpMode: SR Mask                  */

#define EMAC_DmaOpMode_OSF_Pos              (2)                                             /*!< EMAC_T::DmaOpMode: OSF Position             */
#define EMAC_DmaOpMode_OSF_Msk              (0x1ul << EMAC_DmaOpMode_OSF_Pos)               /*!< EMAC_T::DmaOpMode: OSF Mask                 */

#define EMAC_DmaOpMode_RTC_Pos              (3)                                             /*!< EMAC_T::DmaOpMode: RTC Position             */
#define EMAC_DmaOpMode_RTC_Msk              (0x3ul << EMAC_DmaOpMode_RTC_Pos)               /*!< EMAC_T::DmaOpMode: RTC Mask                 */

#define EMAC_DmaOpMode_DGF_Pos              (5)                                             /*!< EMAC_T::DmaOpMode: DGF Position             */
#define EMAC_DmaOpMode_DGF_Msk              (0x1ul << EMAC_DmaOpMode_DGF_Pos)               /*!< EMAC_T::DmaOpMode: DGF Mask                 */

#define EMAC_DmaOpMode_FUF_Pos              (6)                                             /*!< EMAC_T::DmaOpMode: FUF Position             */
#define EMAC_DmaOpMode_FUF_Msk              (0x1ul << EMAC_DmaOpMode_FUF_Pos)               /*!< EMAC_T::DmaOpMode: FUF Mask                 */

#define EMAC_DmaOpMode_FEF_Pos              (7)                                             /*!< EMAC_T::DmaOpMode: FEF Position             */
#define EMAC_DmaOpMode_FEF_Msk              (0x1ul << EMAC_DmaOpMode_FEF_Pos)               /*!< EMAC_T::DmaOpMode: FEF Mask                 */

#define EMAC_DmaOpMode_EFC_Pos              (8)                                             /*!< EMAC_T::DmaOpMode: EFC Position             */
#define EMAC_DmaOpMode_EFC_Msk              (0x1ul << EMAC_DmaOpMode_EFC_Pos)               /*!< EMAC_T::DmaOpMode: EFC Mask                 */

#define EMAC_DmaOpMode_RFA_Pos              (9)                                             /*!< EMAC_T::DmaOpMode: RFA Position             */
#define EMAC_DmaOpMode_RFA_Msk              (0x3ul << EMAC_DmaOpMode_RFA_Pos)               /*!< EMAC_T::DmaOpMode: RFA Mask                 */

#define EMAC_DmaOpMode_RFD_Pos              (11)                                            /*!< EMAC_T::DmaOpMode: RFD Position             */
#define EMAC_DmaOpMode_RFD_Msk              (0x3ul << EMAC_DmaOpMode_RFD_Pos)               /*!< EMAC_T::DmaOpMode: RFD Mask                 */

#define EMAC_DmaOpMode_ST_Pos               (13)                                            /*!< EMAC_T::DmaOpMode: ST Position              */
#define EMAC_DmaOpMode_ST_Msk               (0x1ul << EMAC_DmaOpMode_ST_Pos)                /*!< EMAC_T::DmaOpMode: ST Mask                  */

#define EMAC_DmaOpMode_TTC_Pos              (14)                                            /*!< EMAC_T::DmaOpMode: TTC Position             */
#define EMAC_DmaOpMode_TTC_Msk              (0x7ul << EMAC_DmaOpMode_TTC_Pos)               /*!< EMAC_T::DmaOpMode: TTC Mask                 */

#define EMAC_DmaOpMode_FTF_Pos              (20)                                            /*!< EMAC_T::DmaOpMode: FTF Position             */
#define EMAC_DmaOpMode_FTF_Msk              (0x1ul << EMAC_DmaOpMode_FTF_Pos)               /*!< EMAC_T::DmaOpMode: FTF Mask                 */

#define EMAC_DmaOpMode_TSF_Pos              (21)                                            /*!< EMAC_T::DmaOpMode: TSF Position             */
#define EMAC_DmaOpMode_TSF_Msk              (0x1ul << EMAC_DmaOpMode_TSF_Pos)               /*!< EMAC_T::DmaOpMode: TSF Mask                 */

#define EMAC_DmaOpMode_DFF_Pos              (24)                                            /*!< EMAC_T::DmaOpMode: DFF Position             */
#define EMAC_DmaOpMode_DFF_Msk              (0x1ul << EMAC_DmaOpMode_DFF_Pos)               /*!< EMAC_T::DmaOpMode: DFF Mask                 */

#define EMAC_DmaOpMode_RSF_Pos              (25)                                            /*!< EMAC_T::DmaOpMode: RSF Position             */
#define EMAC_DmaOpMode_RSF_Msk              (0x1ul << EMAC_DmaOpMode_RSF_Pos)               /*!< EMAC_T::DmaOpMode: RSF Mask                 */

#define EMAC_DmaOpMode_DT_Pos               (26)                                            /*!< EMAC_T::DmaOpMode: DT Position              */
#define EMAC_DmaOpMode_DT_Msk               (0x1ul << EMAC_DmaOpMode_DT_Pos)                /*!< EMAC_T::DmaOpMode: DT Mask                  */

#define EMAC_DmaInt_TIE_Pos                 (0)                                             /*!< EMAC_T::DmaInt: TIE Position           */
#define EMAC_DmaInt_TIE_Msk                 (0x1ul << EMAC_DmaInt_TIE_Pos)                  /*!< EMAC_T::DmaInt: TIE Mask               */

#define EMAC_DmaInt_TSE_Pos                 (1)                                             /*!< EMAC_T::DmaInt: TSE Position           */
#define EMAC_DmaInt_TSE_Msk                 (0x1ul << EMAC_DmaInt_TSE_Pos)                  /*!< EMAC_T::DmaInt: TSE Mask               */

#define EMAC_DmaInt_TUE_Pos                 (2)                                             /*!< EMAC_T::DmaInt: TUE Position           */
#define EMAC_DmaInt_TUE_Msk                 (0x1ul << EMAC_DmaInt_TUE_Pos)                  /*!< EMAC_T::DmaInt: TUE Mask               */

#define EMAC_DmaInt_TJE_Pos                 (3)                                             /*!< EMAC_T::DmaInt: TJE Position           */
#define EMAC_DmaInt_TJE_Msk                 (0x1ul << EMAC_DmaInt_TJE_Pos)                  /*!< EMAC_T::DmaInt: TJE Mask               */

#define EMAC_DmaInt_OVE_Pos                 (4)                                             /*!< EMAC_T::DmaInt: OVE Position           */
#define EMAC_DmaInt_OVE_Msk                 (0x1ul << EMAC_DmaInt_OVE_Pos)                  /*!< EMAC_T::DmaInt: OVE Mask               */

#define EMAC_DmaInt_UNE_Pos                 (5)                                             /*!< EMAC_T::DmaInt: UNE Position           */
#define EMAC_DmaInt_UNE_Msk                 (0x1ul << EMAC_DmaInt_UNE_Pos)                  /*!< EMAC_T::DmaInt: UNE Mask               */

#define EMAC_DmaInt_RIE_Pos                 (6)                                             /*!< EMAC_T::DmaInt: RIE Position           */
#define EMAC_DmaInt_RIE_Msk                 (0x1ul << EMAC_DmaInt_RIE_Pos)                  /*!< EMAC_T::DmaInt: RIE Mask               */

#define EMAC_DmaInt_RUE_Pos                 (7)                                             /*!< EMAC_T::DmaInt: RUE Position           */
#define EMAC_DmaInt_RUE_Msk                 (0x1ul << EMAC_DmaInt_RUE_Pos)                  /*!< EMAC_T::DmaInt: RUE Mask               */

#define EMAC_DmaInt_RSE_Pos                 (8)                                             /*!< EMAC_T::DmaInt: RSE Position           */
#define EMAC_DmaInt_RSE_Msk                 (0x1ul << EMAC_DmaInt_RSE_Pos)                  /*!< EMAC_T::DmaInt: RSE Mask               */

#define EMAC_DmaInt_RWE_Pos                 (9)                                             /*!< EMAC_T::DmaInt: RWE Position           */
#define EMAC_DmaInt_RWE_Msk                 (0x1ul << EMAC_DmaInt_RWE_Pos)                  /*!< EMAC_T::DmaInt: RWE Mask               */

#define EMAC_DmaInt_ETE_Pos                 (10)                                            /*!< EMAC_T::DmaInt: ETE Position           */
#define EMAC_DmaInt_ETE_Msk                 (0x1ul << EMAC_DmaInt_ETE_Pos)                  /*!< EMAC_T::DmaInt: ETE Mask               */

#define EMAC_DmaInt_FBE_Pos                 (13)                                            /*!< EMAC_T::DmaInt: FBE Position           */
#define EMAC_DmaInt_FBE_Msk                 (0x1ul << EMAC_DmaInt_FBE_Pos)                  /*!< EMAC_T::DmaInt: FBE Mask               */

#define EMAC_DmaInt_ERE_Pos                 (14)                                            /*!< EMAC_T::DmaInt: ERE Position           */
#define EMAC_DmaInt_ERE_Msk                 (0x1ul << EMAC_DmaInt_ERE_Pos)                  /*!< EMAC_T::DmaInt: ERE Mask               */

#define EMAC_DmaInt_AIE_Pos                 (15)                                            /*!< EMAC_T::DmaInt: AIE Position           */
#define EMAC_DmaInt_AIE_Msk                 (0x1ul << EMAC_DmaInt_AIE_Pos)                  /*!< EMAC_T::DmaInt: AIE Mask               */

#define EMAC_DmaInt_NIE_Pos                 (16)                                            /*!< EMAC_T::DmaInt: NIE Position           */
#define EMAC_DmaInt_NIE_Msk                 (0x1ul << EMAC_DmaInt_NIE_Pos)                  /*!< EMAC_T::DmaInt: NIE Mask               */

#define EMAC_DmaMissedFrame_MISFRMCNT_Pos   (0)                                             /*!< EMAC_T::DmaMissedFrame: MISFRMCNT Position*/
#define EMAC_DmaMissedFrame_MISFRMCNT_Msk   (0xfffful << EMAC_DmaMissedFrame_MISFRMCNT_Pos) /*!< EMAC_T::DmaMissedFrame: MISFRMCNT Mask*/

#define EMAC_DmaMissedFrame_MISCNTOVF_Pos   (16)                                            /*!< EMAC_T::DmaMissedFrame: MISCNTOVF Position*/
#define EMAC_DmaMissedFrame_MISCNTOVF_Msk   (0x1ul << EMAC_DmaMissedFrame_MISCNTOVF_Pos)    /*!< EMAC_T::DmaMissedFrame: MISCNTOVF Mask*/

#define EMAC_DmaMissedFrame_OVFFRMCNT_Pos   (17)                                            /*!< EMAC_T::DmaMissedFrame: OVFFRMCNT Position*/
#define EMAC_DmaMissedFrame_OVFFRMCNT_Msk   (0x7fful << EMAC_DmaMissedFrame_OVFFRMCNT_Pos)  /*!< EMAC_T::DmaMissedFrame: OVFFRMCNT Mask*/

#define EMAC_DmaMissedFrame_OVFCNTOVF_Pos   (28)                                            /*!< EMAC_T::DmaMissedFrame: OVFCNTOVF Position*/
#define EMAC_DmaMissedFrame_OVFCNTOVF_Msk   (0x1ul << EMAC_DmaMissedFrame_OVFCNTOVF_Pos)    /*!< EMAC_T::DmaMissedFrame: OVFCNTOVF Mask*/

#define EMAC_DmaRxIntWdt_RIWT_Pos           (0)                                             /*!< EMAC_T::DmaRxIntWdt: RIWT Position*/
#define EMAC_DmaRxIntWdt_RIWT_Msk           (0xfful << EMAC_DmaRxIntWdt_RIWT_Pos)           /*!< EMAC_T::DmaRxIntWdt: RIWT Mask*/

#define EMAC_DmaAxiBusMode_UNDEF_Pos        (0)                                             /*!< EMAC_T::DmaAxiBusMode: UNDEF Position       */
#define EMAC_DmaAxiBusMode_UNDEF_Msk        (0x1ul << EMAC_DmaAxiBusMode_UNDEF_Pos)         /*!< EMAC_T::DmaAxiBusMode: UNDEF Mask           */

#define EMAC_DmaAxiBusMode_BLEN4_Pos        (1)                                             /*!< EMAC_T::DmaAxiBusMode: BLEN4 Position       */
#define EMAC_DmaAxiBusMode_BLEN4_Msk        (0x1ul << EMAC_DmaAxiBusMode_BLEN4_Pos)         /*!< EMAC_T::DmaAxiBusMode: BLEN4 Mask           */

#define EMAC_DmaAxiBusMode_BLEN8_Pos        (2)                                             /*!< EMAC_T::DmaAxiBusMode: BLEN8 Position       */
#define EMAC_DmaAxiBusMode_BLEN8_Msk        (0x1ul << EMAC_DmaAxiBusMode_BLEN8_Pos)         /*!< EMAC_T::DmaAxiBusMode: BLEN8 Mask           */

#define EMAC_DmaAxiBusMode_BLEN16_Pos       (3)                                             /*!< EMAC_T::DmaAxiBusMode: BLEN16 Position      */
#define EMAC_DmaAxiBusMode_BLEN16_Msk       (0x1ul << EMAC_DmaAxiBusMode_BLEN16_Pos)        /*!< EMAC_T::DmaAxiBusMode: BLEN16 Mask          */

#define EMAC_DmaAxiBusMode_AXI_AAL_Pos      (12)                                            /*!< EMAC_T::DmaAxiBusMode: AXI_AAL Position     */
#define EMAC_DmaAxiBusMode_AXI_AAL_Msk      (0x1ul << EMAC_DmaAxiBusMode_AXI_AAL_Pos)       /*!< EMAC_T::DmaAxiBusMode: AXI_AAL Mask         */

#define EMAC_DmaAxiBusMode_ONEKBBE_Pos      (13)                                            /*!< EMAC_T::DmaAxiBusMode: ONEKBBE Position     */
#define EMAC_DmaAxiBusMode_ONEKBBE_Msk      (0x1ul << EMAC_DmaAxiBusMode_ONEKBBE_Pos)       /*!< EMAC_T::DmaAxiBusMode: ONEKBBE Mask         */

#define EMAC_DmaAxiBusMode_RD_OSR_LMT_Pos   (16)                                            /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT Position  */
#define EMAC_DmaAxiBusMode_RD_OSR_LMT_Msk   (0x3ul << EMAC_DmaAxiBusMode_RD_OSR_LMT_Pos)    /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT Mask      */

#define EMAC_DmaAxiBusMode_RD_OSR_LMT_GT4_Pos (18)                                              /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT_GT4 Position*/
#define EMAC_DmaAxiBusMode_RD_OSR_LMT_GT4_Msk (0x1ul << EMAC_DmaAxiBusMode_RD_OSR_LMT_GT4_Pos)  /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT_GT4 Mask  */

#define EMAC_DmaAxiBusMode_RD_OSR_LMT_GT8_Pos (19)                                              /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT_GT8 Position*/
#define EMAC_DmaAxiBusMode_RD_OSR_LMT_GT8_Msk (0x1ul << EMAC_DmaAxiBusMode_RD_OSR_LMT_GT8_Pos)  /*!< EMAC_T::DmaAxiBusMode: RD_OSR_LMT_GT8 Mask  */

#define EMAC_DmaAxiBusMode_WR_OSR_LMT_Pos     (20)                                              /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT Position  */
#define EMAC_DmaAxiBusMode_WR_OSR_LMT_Msk     (0x3ul << EMAC_DmaAxiBusMode_WR_OSR_LMT_Pos)      /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT Mask      */

#define EMAC_DmaAxiBusMode_WR_OSR_LMT_GT4_Pos (22)                                              /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT_GT4 Position*/
#define EMAC_DmaAxiBusMode_WR_OSR_LMT_GT4_Msk (0x1ul << EMAC_DmaAxiBusMode_WR_OSR_LMT_GT4_Pos)  /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT_GT4 Mask  */

#define EMAC_DmaAxiBusMode_WR_OSR_LMT_GT8_Pos (23)                                              /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT_GT8 Position*/
#define EMAC_DmaAxiBusMode_WR_OSR_LMT_GT8_Msk (0x1ul << EMAC_DmaAxiBusMode_WR_OSR_LMT_GT8_Pos)  /*!< EMAC_T::DmaAxiBusMode: WR_OSR_LMT_GT8 Mask  */

#define EMAC_DmaAxiBusMode_LPI_XIT_FRM_Pos    (30)                                              /*!< EMAC_T::DmaAxiBusMode: LPI_XIT_FRM Position */
#define EMAC_DmaAxiBusMode_LPI_XIT_FRM_Msk    (0x1ul << EMAC_DmaAxiBusMode_LPI_XIT_FRM_Pos)     /*!< EMAC_T::DmaAxiBusMode: LPI_XIT_FRM Mask     */

#define EMAC_DmaAxiBusMode_EN_LPI_Pos         (31)                                              /*!< EMAC_T::DmaAxiBusMode: EN_LPI Position      */
#define EMAC_DmaAxiBusMode_EN_LPI_Msk         (0x1ul << EMAC_DmaAxiBusMode_EN_LPI_Pos)          /*!< EMAC_T::DmaAxiBusMode: EN_LPI Mask          */

#define EMAC_DmaAhbAxiStatus_AXWHSTS_Pos      (0)                                               /*!< EMAC_T::DmaAhbAxiStatus: AXWHSTS Position*/
#define EMAC_DmaAhbAxiStatus_AXWHSTS_Msk      (0x1ul << EMAC_DmaAhbAxiStatus_AXWHSTS_Pos)       /*!< EMAC_T::DmaAhbAxiStatus: AXWHSTS Mask    */

#define EMAC_DmaAhbAxiStatus_AXIRDSTS_Pos     (1)                                               /*!< EMAC_T::DmaAhbAxiStatus: AXIRDSTS Position*/
#define EMAC_DmaAhbAxiStatus_AXIRDSTS_Msk     (0x1ul << EMAC_DmaAhbAxiStatus_AXIRDSTS_Pos)      /*!< EMAC_T::DmaAhbAxiStatus: AXIRDSTS Mask   */

#define EMAC_DmaCurrTxDesc_CURTDESAPTR_Pos    (0)                                               /*!< EMAC_T::DmaCurrTxDesc: CURTDESAPTR Position*/
#define EMAC_DmaCurrTxDesc_CURTDESAPTR_Msk    (0xfffffffful << EMAC_DmaCurrTxDesc_CURTDESAPTR_Pos) /*!< EMAC_T::DmaCurrTxDesc: CURTDESAPTR Mask*/

#define EMAC_DmaCurrRxDesc_CURRDESAPTR_Pos    (0)                                               /*!< EMAC_T::DmaCurrRxDesc: CURRDESAPTR Position*/
#define EMAC_DmaCurrRxDesc_CURRDESAPTR_Msk    (0xfffffffful << EMAC_DmaCurrRxDesc_CURRDESAPTR_Pos) /*!< EMAC_T::DmaCurrRxDesc: CURRDESAPTR Mask*/

#define EMAC_DmaCurrTxAddr_CURTBUFAPTR_Pos    (0)                                               /*!< EMAC_T::DmaCurrTxAddr: CURTBUFAPTR Position*/
#define EMAC_DmaCurrTxAddr_CURTBUFAPTR_Msk    (0xfffffffful << EMAC_DmaCurrTxAddr_CURTBUFAPTR_Pos) /*!< EMAC_T::DmaCurrTxAddr: CURTBUFAPTR Mask*/

#define EMAC_DmaCurrRxAddr_CURRBUFAPTR_Pos    (0)                                               /*!< EMAC_T::DmaCurrRxAddr: CURRBUFAPTR Position*/
#define EMAC_DmaCurrRxAddr_CURRBUFAPTR_Msk    (0xfffffffful << EMAC_DmaCurrRxAddr_CURRBUFAPTR_Pos) /*!< EMAC_T::DmaCurrRxAddr: CURRBUFAPTR Mask*/

#define EMAC_HwFeature_MIISEL_Pos             (0)                                               /*!< EMAC_T::HwFeature: MIISEL Position       */
#define EMAC_HwFeature_MIISEL_Msk             (0x1ul << EMAC_HwFeature_MIISEL_Pos)              /*!< EMAC_T::HwFeature: MIISEL Mask           */

#define EMAC_HwFeature_GMIISEL_Pos            (1)                                               /*!< EMAC_T::HwFeature: GMIISEL Position      */
#define EMAC_HwFeature_GMIISEL_Msk            (0x1ul << EMAC_HwFeature_GMIISEL_Pos)             /*!< EMAC_T::HwFeature: GMIISEL Mask          */

#define EMAC_HwFeature_HDSEL_Pos              (2)                                               /*!< EMAC_T::HwFeature: HDSEL Position        */
#define EMAC_HwFeature_HDSEL_Msk              (0x1ul << EMAC_HwFeature_HDSEL_Pos)               /*!< EMAC_T::HwFeature: HDSEL Mask            */

#define EMAC_HwFeature_EXTHASHEN_Pos          (3)                                               /*!< EMAC_T::HwFeature: EXTHASHEN Position    */
#define EMAC_HwFeature_EXTHASHEN_Msk          (0x1ul << EMAC_HwFeature_EXTHASHEN_Pos)           /*!< EMAC_T::HwFeature: EXTHASHEN Mask        */

#define EMAC_HwFeature_HASHSEL_Pos            (4)                                               /*!< EMAC_T::HwFeature: HASHSEL Position      */
#define EMAC_HwFeature_HASHSEL_Msk            (0x1ul << EMAC_HwFeature_HASHSEL_Pos)             /*!< EMAC_T::HwFeature: HASHSEL Mask          */

#define EMAC_HwFeature_ADDMACADRSEL_Pos       (5)                                               /*!< EMAC_T::HwFeature: ADDMACADRSEL Position */
#define EMAC_HwFeature_ADDMACADRSEL_Msk       (0x1ul << EMAC_HwFeature_ADDMACADRSEL_Pos)        /*!< EMAC_T::HwFeature: ADDMACADRSEL Mask     */

#define EMAC_HwFeature_PCSSEL_Pos             (6)                                               /*!< EMAC_T::HwFeature: PCSSEL Position       */
#define EMAC_HwFeature_PCSSEL_Msk             (0x1ul << EMAC_HwFeature_PCSSEL_Pos)              /*!< EMAC_T::HwFeature: PCSSEL Mask           */

#define EMAC_HwFeature_L3L4FLTREN_Pos         (7)                                               /*!< EMAC_T::HwFeature: L3L4FLTREN Position   */
#define EMAC_HwFeature_L3L4FLTREN_Msk         (0x1ul << EMAC_HwFeature_L3L4FLTREN_Pos)          /*!< EMAC_T::HwFeature: L3L4FLTREN Mask       */

#define EMAC_HwFeature_SMASEL_Pos             (8)                                               /*!< EMAC_T::HwFeature: SMASEL Position       */
#define EMAC_HwFeature_SMASEL_Msk             (0x1ul << EMAC_HwFeature_SMASEL_Pos)              /*!< EMAC_T::HwFeature: SMASEL Mask           */

#define EMAC_HwFeature_RWKSEL_Pos             (9)                                               /*!< EMAC_T::HwFeature: RWKSEL Position       */
#define EMAC_HwFeature_RWKSEL_Msk             (0x1ul << EMAC_HwFeature_RWKSEL_Pos)              /*!< EMAC_T::HwFeature: RWKSEL Mask           */

#define EMAC_HwFeature_MGKSEL_Pos             (10)                                              /*!< EMAC_T::HwFeature: MGKSEL Position       */
#define EMAC_HwFeature_MGKSEL_Msk             (0x1ul << EMAC_HwFeature_MGKSEL_Pos)              /*!< EMAC_T::HwFeature: MGKSEL Mask           */

#define EMAC_HwFeature_MMCSEL_Pos             (11)                                              /*!< EMAC_T::HwFeature: MMCSEL Position       */
#define EMAC_HwFeature_MMCSEL_Msk             (0x1ul << EMAC_HwFeature_MMCSEL_Pos)              /*!< EMAC_T::HwFeature: MMCSEL Mask           */

#define EMAC_HwFeature_TSVER1SEL_Pos          (12)                                              /*!< EMAC_T::HwFeature: TSVER1SEL Position    */
#define EMAC_HwFeature_TSVER1SEL_Msk          (0x1ul << EMAC_HwFeature_TSVER1SEL_Pos)           /*!< EMAC_T::HwFeature: TSVER1SEL Mask        */

#define EMAC_HwFeature_TSVER2SEL_Pos          (13)                                              /*!< EMAC_T::HwFeature: TSVER2SEL Position    */
#define EMAC_HwFeature_TSVER2SEL_Msk          (0x1ul << EMAC_HwFeature_TSVER2SEL_Pos)           /*!< EMAC_T::HwFeature: TSVER2SEL Mask        */

#define EMAC_HwFeature_EEESEL_Pos             (14)                                              /*!< EMAC_T::HwFeature: EEESEL Position       */
#define EMAC_HwFeature_EEESEL_Msk             (0x1ul << EMAC_HwFeature_EEESEL_Pos)              /*!< EMAC_T::HwFeature: EEESEL Mask           */

#define EMAC_HwFeature_AVSEL_Pos              (15)                                              /*!< EMAC_T::HwFeature: AVSEL Position        */
#define EMAC_HwFeature_AVSEL_Msk              (0x1ul << EMAC_HwFeature_AVSEL_Pos)               /*!< EMAC_T::HwFeature: AVSEL Mask            */

#define EMAC_HwFeature_TXCOESEL_Pos           (16)                                              /*!< EMAC_T::HwFeature: TXCOESEL Position     */
#define EMAC_HwFeature_TXCOESEL_Msk           (0x1ul << EMAC_HwFeature_TXCOESEL_Pos)            /*!< EMAC_T::HwFeature: TXCOESEL Mask         */

#define EMAC_HwFeature_RXTYP1COE_Pos          (17)                                              /*!< EMAC_T::HwFeature: RXTYP1COE Position    */
#define EMAC_HwFeature_RXTYP1COE_Msk          (0x1ul << EMAC_HwFeature_RXTYP1COE_Pos)           /*!< EMAC_T::HwFeature: RXTYP1COE Mask        */

#define EMAC_HwFeature_RXTYP2COE_Pos          (18)                                              /*!< EMAC_T::HwFeature: RXTYP2COE Position    */
#define EMAC_HwFeature_RXTYP2COE_Msk          (0x1ul << EMAC_HwFeature_RXTYP2COE_Pos)           /*!< EMAC_T::HwFeature: RXTYP2COE Mask        */

#define EMAC_HwFeature_RXFIFOSIZE_Pos         (19)                                              /*!< EMAC_T::HwFeature: RXFIFOSIZE Position   */
#define EMAC_HwFeature_RXFIFOSIZE_Msk         (0x1ul << EMAC_HwFeature_RXFIFOSIZE_Pos)          /*!< EMAC_T::HwFeature: RXFIFOSIZE Mask       */

#define EMAC_HwFeature_RXCHCNT_Pos            (20)                                              /*!< EMAC_T::HwFeature: RXCHCNT Position      */
#define EMAC_HwFeature_RXCHCNT_Msk            (0x3ul << EMAC_HwFeature_RXCHCNT_Pos)             /*!< EMAC_T::HwFeature: RXCHCNT Mask          */

#define EMAC_HwFeature_TXCHCNT_Pos            (22)                                              /*!< EMAC_T::HwFeature: TXCHCNT Position      */
#define EMAC_HwFeature_TXCHCNT_Msk            (0x3ul << EMAC_HwFeature_TXCHCNT_Pos)             /*!< EMAC_T::HwFeature: TXCHCNT Mask          */

#define EMAC_HwFeature_ENHDESSEL_Pos          (24)                                              /*!< EMAC_T::HwFeature: ENHDESSEL Position    */
#define EMAC_HwFeature_ENHDESSEL_Msk          (0x1ul << EMAC_HwFeature_ENHDESSEL_Pos)           /*!< EMAC_T::HwFeature: ENHDESSEL Mask        */

#define EMAC_HwFeature_INTTSEN_Pos            (25)                                              /*!< EMAC_T::HwFeature: INTTSEN Position      */
#define EMAC_HwFeature_INTTSEN_Msk            (0x1ul << EMAC_HwFeature_INTTSEN_Pos)             /*!< EMAC_T::HwFeature: INTTSEN Mask          */

#define EMAC_HwFeature_FLEXIPPSEN_Pos         (26)                                              /*!< EMAC_T::HwFeature: FLEXIPPSEN Position   */
#define EMAC_HwFeature_FLEXIPPSEN_Msk         (0x1ul << EMAC_HwFeature_FLEXIPPSEN_Pos)          /*!< EMAC_T::HwFeature: FLEXIPPSEN Mask       */

#define EMAC_HwFeature_SAVLANINS_Pos          (27)                                              /*!< EMAC_T::HwFeature: SAVLANINS Position    */
#define EMAC_HwFeature_SAVLANINS_Msk          (0x1ul << EMAC_HwFeature_SAVLANINS_Pos)           /*!< EMAC_T::HwFeature: SAVLANINS Mask        */

#define EMAC_HwFeature_ACTPHYIF_Pos           (28)                                              /*!< EMAC_T::HwFeature: ACTPHYIF Position     */
#define EMAC_HwFeature_ACTPHYIF_Msk           (0x7ul << EMAC_HwFeature_ACTPHYIF_Pos)            /*!< EMAC_T::HwFeature: ACTPHYIF Mask         */
