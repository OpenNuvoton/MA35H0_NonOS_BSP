...
#define IRQ_MODE_MA35H0MAIN_Pos         (4U)
#define IRQ_MODE_MA35H0MAIN_Msk         (0x01UL << IRQ_MODE_MA35H0MAIN_Pos)
#define IRQ_MODE_MA35H0MAIN_NONSECURE   (0x00UL << IRQ_MODE_MA35H0MAIN_Pos)   ///< MA35H0main: interrupt is targeting non-secure MA35H0main
#define IRQ_MODE_MA35H0MAIN_SECURE      (0x01UL << IRQ_MODE_MA35H0MAIN_Pos)   ///< MA35H0main: interrupt is targeting secure MA35H0main
