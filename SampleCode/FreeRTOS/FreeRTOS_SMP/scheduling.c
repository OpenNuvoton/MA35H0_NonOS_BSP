 ...
 *
 * Setup:
 *   - TIMER2 fires at 0.8 MHz (GIC priority = lower urgency, higher number)
 *   - TIMER3 fires at 0.8 MHz (GIC priority = higher urgency, lower number)
...
static void prvDemo2Task( void *pv )
{
    ...
    /* TIMER2: 0.8 MHz, lower urgency. */
    TIMER_Open( TIMER2, TIMER_PERIODIC_MODE, 800000 );
    ...
    /* TIMER3: 0.8 MHz, higher urgency - can nest inside TIMER2's ISR. */
    TIMER_Open( TIMER3, TIMER_PERIODIC_MODE, 800000 );
