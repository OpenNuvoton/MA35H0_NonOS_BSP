 ...
 * @file     main.c
 * @version  V1.00
 * @brief    This loader is designed for custom DDR situation. MA35H0 IBR will
...
void ddr_init(void)
{
	...
	//Set TAHBCKEN,CM4CKEN,CA35CKEN,DDR6CKEN,GFXCKEN,VC8KCKEN,DCUCKEN,EMAC0CKEN,EMAC1CKEN,CAP0CKEN,CAP1CKEN
...
int main()
{
    ...
    sysprintf("MA35H0 baremetal loader...\n");
